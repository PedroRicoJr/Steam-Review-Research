...
| 5 | Warframe | `warframe` | 230410 | **Done** - pulled 2026-09-14, 3,235 of 3,260 planned, +/-2.16%; read 2026-09-24 to 09-25 in two sessions (batches 1-14 before the stop of 2026-09-24, 15-64 on 2026-09-25); findings 2026-09-25 to 09-26 (`findings/warframe-english.md`, `findings/warframe.md`, cross-game section 20) | 676,726 | 87.8% | Very Positive | 2013-03 | **300,944** | +/-2.5% | TPS co-op looter, free, thirteen years of live service |
...
| 8 | Escape from Duckov | `escape-from-duckov` | 3167020 | **WIP** - pulled 2026-09-26, 1,166 of 1,362 planned, **+/-2.83%** (Steam returned 294 of the 490 wanted in 2025-10, the launch month); reading in batches of 50 - 1,050 of 1,166 read | 104,482 | 84% | Very Positive | 2025-10 | **11,004** | +/-2.5% | PvE extraction survival - A1 on `planning/action-roguelike-list.md`, the closest match to Dominion on either list; picked by the active loop under Rico's standing order of 2026-09-25 |
