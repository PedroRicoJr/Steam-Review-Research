...
recommend it and say nothing; the counts below are built from the half who said something.**

⚠️ **223 reviews carry a later edit and are counted on the day they were created** — 11.8%, the highest
share in the queue (Space Marine 2 10.9%). Most of the Gearbox-era lines are 2024–2026 edits sitting on
2019–2023 dates. The flattening question is open with Rico.
...
|---|---|---|
| `review` (said nothing specific) | 1,060 | 39.5% |
| `game-design` | 905 | 33.7% |
| `community` | 146 | 5.4% |
| `publishing` | 114 | 4.2% |
| `marketing` | 92 | 3.4% |
| `engineering` | 84 | 3.1% |
...
| Count | Tag | |
|---|---|---|
| 948 | `review.positive.unknown` | + |
| 172 | `game-design.replayability.keeps-pulling-you-back` | + |
| 88 | `community.playing-with-friends.much-better-with-friends` | + |
| 73 | `game-design.game-feel.combat.makes-you-feel-superhumanly-strong` | + |
| 71 | `audio.music.fits-the-game` | + |
| 60 | `game-design.role-design.unknown` | ~ |
| 44 | `marketing.positioning.successor-framing-accepted` | + |
| 44 | `game-design.enemy-design.unknown` | ~ |
| 44 | `game-design.difficulty-tuning.satisfyingly-hard` | + |
| 39 | `game-design.progression.unlock-pace.satisfying-progression` | + |
| 37 | `game-design.role-design.each-role-plays-its-own-way` | + |
| 34 | `game-design.solo-viability.works-solo` | + |
| 34 | `review.repeats-a-copied-meme-text` | ~ |
| 31 | `community.user-created-content.mods-extend-the-game` | + |
| 30 | `publishing.price.fair` | + |
| 30 | `game-design.difficulty-tuning.unknown` | ~ |
| 29 | `game-design.progression.build-and-customisation.deep-and-varied` | + |
| 26 | `game-design.randomness.randomness-keeps-it-fresh` | + |
| 26 | `publishing.dlc-and-editions.dlc-is-fair` | + |
...
Per 100 reviews in each period: EA = 2019-03 to 2020-07 (364 read), V1 = 2020-08 to 2021-12 (376),
22–23 = 2022–2023 (489), 2024 (241), 25–26 = 2025-01 to 2026-09 (415).

| # | Mode | Count | Per 100 | EA | V1 | 22–23 | 2024 | 25–26 |
|---|---|---|---|---|---|---|---|---|
| 1 | `review.negative.unknown` | **22** | 1.2 | 0.5 | 0.5 | 1.0 | **2.5** | 1.7 |
| 2 | `art.effects-and-gore.effects-block-your-view` | **14** | 0.7 | 0.8 | 0.3 | 0.6 | **2.1** | 0.5 |
| 3 | `game-design.co-op-design.teammates-can-take-your-things` | **12** | 0.6 | **1.1** | 0.5 | 0.4 | 0.4 | 0.7 |
| 4 | `publishing.ownership.owner-puts-players-off` | **11** | 0.6 | 0.0 | 0.0 | 0.6 | **1.7** | 1.0 |
| 5 | `engineering.servers.frequent-disconnects` | **10** | 0.5 | 0.5 | 0.0 | 0.2 | **1.2** | 1.0 |
| 6 | `live-ops.patch-quality.made-it-worse` | **10** | 0.5 | 0.0 | 0.8 | 0.4 | **1.7** | 0.2 |
| 7 | `production.content-variety.repetitive` | **9** | 0.5 | 0.8 | 0.3 | 0.6 | 0.0 | 0.5 |
| 8 | `engineering.performance.unstable-framerate` | **8** | 0.4 | 0.5 | **1.1** | 0.2 | 0.0 | 0.2 |
| 9 | `game-design.enemy-design.one-hit-kills` | **7** | 0.4 | 0.0 | 0.3 | 0.0 | 0.8 | **1.0** |
| 10 | `game-design.level-design.the-way-onward-is-hard-to-find` | **6** | 0.3 | 0.5 | 0.3 | 0.2 | 0.0 | 0.5 |
...
| 18 | `game-design.session-flexibility.cannot-save-and-come-back` | **4** | 0.2 | 0.8 | 0.0 | 0.2 | 0.0 | 0.0 |
| 19 | `engineering.bugs.buggy` | **4** | 0.2 | 0.3 | 0.5 | 0.0 | 0.0 | 0.2 |
| 20 | `audio.music.forgettable-or-annoying` | **4** | 0.2 | 0.3 | 0.5 | 0.0 | 0.0 | 0.2 |
...
*visual overload* — and it is a complaint in the tree because the words say you cannot see; the thumb
is up in 12 of 14. The loot-taking teammate (row 3) is a co-op design fact, said 12 times across seven
years and once as *JACKSON*. It is the only complaint the early-access reviews make more than the
later ones.

**Rows 9, 13 and 23 rise together in 2025–26, and they are three sides of one thing.** *You die in a
second* (row 9), *too easy* (row 13) and *no tutorial, no explanations* (row 23) each reach 1.0 per
100 in the last period, from near zero before. One reviewer holds all three: *"Too easy, until those
...
| # | Mode | Count | Per 100 | EA | V1 | 22–23 | 2024 | 25–26 |
|---|---|---|---|---|---|---|---|---|
| 1 | `game-design.replayability.keeps-pulling-you-back` | **172** | 9.1 | **11.5** | 10.6 | 7.8 | 10.4 | 6.5 |
| 2 | `community.playing-with-friends.much-better-with-friends` | **88** | 4.7 | **7.7** | 6.1 | 3.1 | 4.1 | 2.9 |
| 3 | `game-design.game-feel.combat.makes-you-feel-superhumanly-strong` | **73** | 3.9 | 3.8 | **6.9** | 4.1 | 2.5 | 1.7 |
| 4 | `audio.music.fits-the-game` | **71** | 3.8 | 3.3 | 2.9 | 2.2 | 5.0 | **6.0** |
| 5 | `marketing.positioning.successor-framing-accepted` | **44** | 2.3 | **8.5** | 2.7 | 0.4 | 0.4 | 0.0 |
| 6 | `game-design.difficulty-tuning.satisfyingly-hard` | **44** | 2.3 | 3.0 | **3.2** | 2.7 | 0.8 | 1.4 |
| 7 | `game-design.progression.unlock-pace.satisfying-progression` | **39** | 2.1 | 1.9 | **3.5** | 1.6 | 2.1 | 1.4 |
| 8 | `game-design.role-design.each-role-plays-its-own-way` | **37** | 2.0 | 2.5 | **3.2** | 1.2 | 1.2 | 1.7 |
| 9 | `game-design.solo-viability.works-solo` | **34** | 1.8 | **3.0** | 2.1 | 1.4 | 1.7 | 1.0 |
| 10 | `community.user-created-content.mods-extend-the-game` | **31** | 1.6 | 0.8 | 1.6 | **2.7** | 2.1 | 1.0 |
| 11 | `publishing.price.fair` | **30** | 1.6 | **2.7** | 1.3 | 2.0 | 1.2 | 0.5 |
| 12 | `game-design.progression.build-and-customisation.deep-and-varied` | **29** | 1.5 | 1.4 | **2.1** | 1.8 | 1.7 | 0.7 |
| 13 | `game-design.randomness.randomness-keeps-it-fresh` | **26** | 1.4 | **2.7** | 1.3 | 0.8 | 0.8 | 1.2 |
| 14 | `publishing.dlc-and-editions.dlc-is-fair` | **26** | 1.4 | 0.0 | 1.3 | 1.2 | **2.5** | 2.2 |
| 15 | `production.early-access.good-value-while-unfinished` | **18** | 1.0 | **4.9** | 0.0 | 0.0 | 0.0 | 0.0 |
| 16 | `art.fidelity.looks-great` | **16** | 0.8 | 0.8 | **1.6** | 0.6 | 0.0 | 1.0 |
| 17 | `live-ops.patch-quality.fixed-what-mattered` | **16** | 0.8 | **2.2** | 0.3 | 0.6 | 0.8 | 0.5 |
| 18 | `game-design.difficulty-tuning.well-graded` | **15** | 0.8 | 0.3 | 1.1 | **1.4** | 0.0 | 0.7 |
| 19 | `game-design.progression.complexity.rewarding-once-learned` | **13** | 0.7 | 0.0 | 1.3 | **1.4** | 0.4 | 0.0 |
| 20 | `narrative.world-and-setting.world-worth-exploring` | **12** | 0.6 | 0.5 | 0.8 | 0.4 | 0.4 | **1.0** |
...
needed explaining. **By 2025 the praise is *peak* and *goated* and a weather joke**, and the bare
thumbs-up climbs from 24% of bullets in early access to 42% in 2025–26.

**Two kinds of praise rise against that tide: the music (row 4, 3.3 → 6.0) and the DLC (row 14, 0 →
2.5).** The music line is the only praise in the corpus that grows for seven years; *and his music
was electric* is quoted eleven times in 2025–26 alone. The DLC line is *Survivors of the Void* being
praised while *Seekers of the Storm* is argued over, and *Alloyed Collective* arriving in 2025-11 to
three *worth it* and no thumbs-down.

**Row 3, the god run, is the game's own mode and it peaks after 1.0** (6.9 per 100 in 2020–21): *start
...
any movement, attacks or abilities — that's Risk of Rain at its peak."* 35 reviews use the word *god*.

**Its inverse appears once, and it is the same sentence with the thumb turned over.** 223339415, 247
hours, thumbs-down: *"you get to a point where it just becomes an idle game… is someone really playing
the game when there is no point to user inputs? Yet I can't stop playing it."* — filed on
`progression-outgrows-the-challenge`, and on `keeps-pulling-you-back` in the same review.

**And the screen it produces is complaint 2 in the table** — `effects-block-your-view`, 14 — written
as a joke twelve times (*vision is overrated anyway*; *I don't know what killed me, would recommend*)
and as a complaint twice (*chaos for the sake of chaos*, thumbs-down at 4 hours; *after some point it's
just an epileptic crisis*, thumbs-down, 2020-02). **One review asks
...
|---|---|---|---|---|---|---|---|---|---|
| 2019-03 | 5,307 | 5 | 0.09% | 100.0% | 2.80 | 180.0 | 60.0 | 4 | 1 |
| 2019-04 | 6,926 | 29 | 0.42% | 89.7% | 1.52 | 96.6 | 27.6 | 23 | 3 |
| 2019-05 | 1,429 | 20 | 1.40% | 85.0% | 1.85 | 105.0 | 25.0 | 91 | 6 |
| 2019-06 | 5,139 | 22 | 0.43% | 100.0% | 2.00 | 145.5 | 22.7 | 48 | 3 |
| 2019-07 | 5,353 | 23 | 0.43% | 91.3% | 1.74 | 108.7 | 21.7 | 42 | 9 |
| 2019-08 | 371 | 20 | 5.39% | 100.0% | 2.85 | 190.0 | 60.0 | 72 | 7 |
| 2019-09 | 684 | 20 | 2.92% | 95.0% | 2.55 | 165.0 | 55.0 | 56 | 5 |
| 2019-10 | 766 | 20 | 2.61% | 100.0% | 1.65 | 140.0 | 5.0 | 71 | 5 |
| 2019-11 | 6,992 | 30 | 0.43% | 96.7% | 1.43 | 93.3 | 20.0 | 65 | 3 |
| 2019-12 | 5,923 | 25 | 0.42% | 92.0% | 1.88 | 136.0 | 28.0 | 124 | 6 |
| 2020-01 | 3,768 | 20 | 0.53% | 100.0% | 1.10 | 90.0 | 10.0 | 69 | 3 |
| 2020-02 | 2,000 | 20 | 1.00% | 95.0% | 1.20 | 85.0 | 10.0 | 70 | 3 |
| 2020-03 | 2,496 | 20 | 0.80% | 100.0% | 1.60 | 130.0 | 15.0 | 82 | 2 |
| 2020-04 | 7,132 | 30 | 0.42% | 100.0% | 1.57 | 126.7 | 6.7 | 42 | 3 |
| 2020-05 | 2,065 | 20 | 0.97% | 100.0% | 1.30 | 85.0 | 20.0 | 45 | 3 |
| 2020-06 | 1,438 | 20 | 1.39% | 95.0% | 1.60 | 115.0 | 25.0 | 75 | 2 |
| 2020-07 | 1,923 | 20 | 1.04% | 100.0% | 1.40 | 105.0 | 5.0 | 70 | 6 |
| 2020-08 | 8,867 | 37 | 0.42% | 97.3% | 1.43 | 113.5 | 13.5 | 80 | 8 |
| 2020-09 | 4,018 | 20 | 0.50% | 100.0% | 1.30 | 105.0 | 10.0 | 51 | 0 |
| 2020-10 | 2,010 | 20 | 1.00% | 100.0% | 1.75 | 135.0 | 10.0 | 54 | 3 |
| 2020-11 | **9,159** | 39 | 0.43% | 97.4% | 1.69 | 135.9 | 23.1 | 86 | 5 |
| 2020-12 | 2,903 | 20 | 0.69% | 95.0% | 1.40 | 95.0 | 15.0 | 79 | 4 |
| 2021-01 | 3,046 | 20 | 0.66% | 100.0% | 1.45 | 120.0 | 0.0 | 78 | 2 |
| 2021-02 | 1,791 | 20 | 1.12% | 100.0% | 1.25 | 115.0 | 0.0 | 38 | 3 |
| 2021-03 | 3,329 | 20 | 0.60% | 100.0% | 1.25 | 105.0 | 15.0 | 86 | 4 |
| 2021-04 | 3,220 | 20 | 0.62% | 100.0% | 1.55 | 120.0 | 0.0 | 74 | 2 |
| 2021-05 | 1,937 | 20 | 1.03% | 100.0% | 1.15 | 85.0 | 5.0 | 62 | 1 |
| 2021-06 | 1,928 | 20 | 1.04% | 100.0% | 1.50 | 105.0 | 20.0 | 76 | 2 |
| 2021-07 | 2,490 | 20 | 0.80% | 100.0% | 1.35 | 95.0 | 0.0 | 98 | 6 |
| 2021-08 | 1,959 | 20 | 1.02% | 100.0% | 1.90 | 140.0 | 30.0 | 87 | 3 |
| 2021-09 | 1,624 | 20 | 1.23% | 90.0% | 1.95 | 140.0 | 30.0 | 93 | 3 |
| 2021-10 | 1,527 | 20 | 1.31% | 100.0% | 1.20 | 85.0 | 10.0 | 68 | 3 |
| 2021-11 | 3,000 | 20 | 0.67% | 100.0% | 1.80 | 150.0 | 5.0 | 148 | 4 |
| 2021-12 | 2,413 | 20 | 0.83% | 95.0% | 1.65 | 105.0 | 25.0 | 62 | 3 |
| 2022-01 | 3,009 | 20 | 0.66% | 100.0% | 1.25 | 105.0 | 10.0 | 31 | 0 |
| 2022-02 | 2,567 | 20 | 0.78% | 100.0% | 1.40 | 85.0 | 15.0 | 96 | 2 |
| 2022-03 | 6,863 | 29 | 0.42% | 96.6% | 1.41 | 106.9 | 6.9 | 96 | 4 |
| 2022-04 | 3,009 | 20 | 0.66% | 100.0% | 1.40 | 115.0 | 0.0 | 117 | 3 |
| 2022-05 | 2,246 | 20 | 0.89% | 95.0% | 1.15 | 90.0 | 10.0 | 52 | 1 |
| 2022-06 | 2,672 | 20 | 0.75% | 95.0% | 1.40 | 120.0 | 10.0 | 55 | 1 |
| 2022-07 | 2,573 | 20 | 0.78% | 85.0% | 1.40 | 75.0 | 35.0 | 123 | 4 |
| 2022-08 | 1,773 | 20 | 1.13% | 100.0% | 1.00 | 80.0 | 5.0 | 53 | 2 |
| 2022-09 | 1,837 | 20 | 1.09% | 90.0% | 1.20 | 85.0 | 25.0 | 68 | 0 |
| 2022-10 | 1,355 | 20 | 1.48% | 90.0% | 1.15 | 85.0 | 10.0 | 68 | 3 |
| 2022-11 | 2,840 | 20 | 0.70% | 95.0% | 1.30 | 105.0 | 0.0 | 82 | 1 |
| 2022-12 | 2,332 | 20 | 0.86% | 95.0% | 1.30 | 100.0 | 10.0 | 137 | 4 |
| 2023-01 | 2,909 | 20 | 0.69% | 90.0% | 1.65 | 125.0 | 35.0 | 86 | 1 |
| 2023-02 | 1,733 | 20 | 1.15% | 95.0% | 1.30 | 115.0 | 5.0 | 67 | 2 |
| 2023-03 | 1,772 | 20 | 1.13% | 100.0% | 1.00 | 60.0 | 0.0 | 80 | 0 |
| 2023-04 | 1,485 | 20 | 1.35% | 95.0% | 1.20 | 105.0 | 10.0 | 94 | 1 |
| 2023-05 | 1,361 | 20 | 1.47% | 100.0% | 1.10 | 100.0 | 0.0 | 98 | 3 |
| 2023-06 | 1,714 | 20 | 1.17% | 100.0% | 1.85 | 130.0 | 10.0 | 93 | 2 |
| 2023-07 | 2,944 | 20 | 0.68% | 85.0% | 1.00 | 50.0 | 15.0 | 64 | 3 |
| 2023-08 | 1,789 | 20 | 1.12% | 100.0% | 1.10 | 95.0 | 0.0 | 146 | 5 |
| 2023-09 | 1,524 | 20 | 1.31% | 100.0% | 1.15 | 95.0 | 0.0 | 125 | 0 |
| 2023-10 | 1,484 | 20 | 1.35% | 100.0% | 1.05 | 80.0 | 0.0 | 70 | 3 |
| 2023-11 | 4,470 | 20 | 0.45% | 100.0% | 1.85 | 120.0 | 10.0 | 116 | 2 |
| 2023-12 | 2,800 | 20 | 0.71% | 100.0% | 1.05 | 90.0 | 0.0 | 199 | 0 |
| 2024-01 | 2,467 | 20 | 0.81% | 90.0% | 1.30 | 80.0 | 30.0 | 147 | 2 |
| 2024-02 | 1,817 | 20 | 1.10% | 95.0% | 1.20 | 95.0 | 10.0 | 101 | 2 |
| 2024-03 | 1,808 | 20 | 1.11% | 100.0% | 1.25 | 75.0 | 5.0 | 72 | 1 |
| 2024-04 | 1,870 | 20 | 1.07% | 100.0% | 1.10 | 85.0 | 0.0 | 110 | 1 |
| 2024-05 | 2,280 | 20 | 0.88% | 100.0% | 1.15 | 95.0 | 0.0 | 122 | 2 |
| 2024-06 | 2,244 | 20 | 0.89% | 100.0% | 1.15 | 80.0 | 10.0 | 38 | 4 |
| 2024-07 | 2,436 | 20 | 0.82% | 90.0% | 1.40 | 105.0 | 20.0 | 50 | 4 |
| 2024-08 | 4,906 | 21 | 0.43% | **76.2%** | 1.57 | 90.5 | 33.3 | 98 | 0 |
| 2024-09 | 3,992 | 20 | 0.50% | **80.0%** | 1.30 | 65.0 | 35.0 | 104 | 1 |
| 2024-10 | 1,167 | 20 | 1.71% | 95.0% | 1.70 | 120.0 | 10.0 | 158 | 1 |
| 2024-11 | 1,667 | 20 | 1.20% | 100.0% | 1.50 | 105.0 | 25.0 | 88 | 5 |
| 2024-12 | 1,959 | 20 | 1.02% | 90.0% | 1.55 | 85.0 | 40.0 | 111 | 2 |
| 2025-01 | 1,404 | 20 | 1.42% | 95.0% | 1.50 | 125.0 | 15.0 | 67 | 1 |
| 2025-02 | 1,579 | 20 | 1.27% | 100.0% | 1.30 | 100.0 | 5.0 | 58 | 0 |
| 2025-03 | 1,506 | 20 | 1.33% | 85.0% | 1.45 | 80.0 | **55.0** | 60 | 1 |
| 2025-04 | 1,396 | 20 | 1.43% | 95.0% | 1.10 | 85.0 | 5.0 | 60 | 4 |
| 2025-05 | 2,325 | 20 | 0.86% | 85.0% | 1.60 | 105.0 | 30.0 | 65 | 2 |
| 2025-06 | 1,798 | 20 | 1.11% | 95.0% | 1.15 | 100.0 | 5.0 | 130 | 3 |
| 2025-07 | 1,719 | 20 | 1.16% | 100.0% | 1.05 | 85.0 | 5.0 | 75 | 2 |
| 2025-08 | 1,515 | 20 | 1.32% | 90.0% | 1.25 | 85.0 | 25.0 | 68 | 0 |
| 2025-09 | 1,303 | 20 | 1.53% | 95.0% | 1.25 | 110.0 | 5.0 | 80 | 1 |
| 2025-10 | 1,743 | 20 | 1.15% | 85.0% | 1.50 | 90.0 | 35.0 | 67 | 2 |
| 2025-11 | 6,003 | 25 | 0.42% | 96.0% | 1.20 | 100.0 | 4.0 | 143 | 2 |
| 2025-12 | 3,019 | 20 | 0.66% | 90.0% | 1.25 | 80.0 | 30.0 | 47 | 1 |
| 2026-01 | 1,826 | 20 | 1.10% | 85.0% | 1.35 | 85.0 | 30.0 | 94 | 0 |
| 2026-02 | 1,489 | 20 | 1.34% | 100.0% | 1.30 | 105.0 | 0.0 | 120 | 2 |
| 2026-03 | 1,233 | 20 | 1.62% | 100.0% | 1.30 | 80.0 | 10.0 | 110 | 0 |
| 2026-04 | 1,397 | 20 | 1.43% | 90.0% | 1.30 | 85.0 | 25.0 | 55 | 2 |
| 2026-05 | 1,433 | 20 | 1.40% | 95.0% | 1.65 | 125.0 | 10.0 | 91 | 0 |
| 2026-06 | 1,256 | 20 | 1.59% | 95.0% | 1.15 | 80.0 | 30.0 | 50 | 1 |
| 2026-07 | 1,274 | 20 | 1.57% | 100.0% | 1.15 | 85.0 | 20.0 | 63 | 1 |
| 2026-08 | 1,043 | 20 | 1.92% | 95.0% | 1.50 | 110.0 | 25.0 | 48 | 0 |
| 2026-09 | 441 | 10 | 2.27% | 90.0% | 1.40 | 70.0 | 50.0 | 36 | 0 |

The last row is a part month (pulled 2026-09-13). "Read" includes the 9 excluded reviews.

### Read the volume, not the sample

**No launch, no cliff: this game has been reviewed at 1,000 to 9,000 a month for seven and a half
years.** The early-access year (2019-03 to 2020-02) is 44,658 reviews — 18.7% of everything — and the
1.0 year (2020-08 to 2021-07) is 44,698, another 18.7%. **The four biggest months are all events**: 2020-11
(9,159, the anniversary update and the autumn sale), 2020-08 (8,867, 1.0), 2020-04 (7,132, the
Artifacts update and the first lockdown month), 2019-11 (6,992). **The three recent peaks are the
expansions**: 2022-03 (6,863, *Survivors of the Void*), 2024-08 (4,906, *Seekers of the Storm*),
2025-11 (6,003, *Alloyed Collective*). Between events the floor is 1,200 to 3,000 a month and it has
not fallen in seven years — 2026-08 holds 1,043.

**Steam's 93.8% is a seven-year average that hides a two-point step.** The sample thumb is 96–98% for
...
**Twelve modes built during this run (tree 1,076 → 1,088), and eight of the 240 modes used appear in
no other game:**

| Mode | | Built on | Count here |
|---|---|---|---|
| `game-design.level-design.the-levels-are-too-small` | − | batch 5 | 2 |
| `engineering.netcode.the-host-leaving-ends-everyones-run` | − | batch 6 | 1 |
| `game-design.level-design.the-way-onward-is-hard-to-find` | − | batch 7 | 6 |
| `engineering.stability.a-crash-loses-the-run` | − | batch 8 | 4 |
| `publishing.ownership.the-new-owner-is-accepted` | + | batch 13 | 6 |
| `publishing.data-and-privacy.a-consent-wall-was-added-after-purchase` | − | batch 14 | 3 |
| `game-design.progression.unlock-pace.the-strongest-options-are-locked-behind-challenges` | − | batch 14 | 2 |
| `game-design.pacing.the-early-stages-of-every-run-are-dull` | − | batch 17 | 2 (+1 in Terminull Brigade) |
| `game-design.pacing.the-clock-is-the-thrill` | + | batch 18 | 4 (+3 in DRG: Rogue Core) |
| `community.user-created-content.mods-fix-what-the-patch-broke` | − | batch 19 | 2 |
| `game-design.new-player-experience.stuck-with-the-worst-starter` | − | batch 20 | 2 |
| `game-design.pacing.the-action-never-stops` | + | batch 28 | 3 (+2 re-homed in other games) |

**Two of the twelve were built to fix a direction fault the checker cannot see.** `the-clock-is-the-
thrill` and `the-action-never-stops` are approving twins of `a-clock-decides-when-you-leave` and
`no-let-up`; five praise lines across three games had been homed on the − modes because the subject
...
**Waiting for a second sighting (in tag-tree-open-gaps.md, rounds 345–382):** a missing epilepsy
warning; the weak teammate who resents the power gap; the promised content that keeps slipping its
...
- **The sample is 0.79% of the population.** Whole-sample shares carry ±2.64%; any single month carries
  ±20% or worse. Everything said about a month is direction. The five periods (241 to 489 reviews each)
  carry ±5 to ±6.
- **223 reviews (11.8%) were edited after creation and are counted on the created date.** In this
  game that matters more than in any other: the Gearbox sale (2022), the *Seekers of the Storm* launch
  (2024-08) and the EULA (2025-04) all arrive early in the tables through edits. 15 of the 35 Gearbox
  lines sit on a pre-2023 date. The flattening rule is open with Rico.
- **1.42 bullets per review.** 948 reviews said nothing but *yes*. Every per-100 number in this page
