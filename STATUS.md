...
| Last unit done | Round 440: Warframe batch 33, 50 reviews, 6 modes (1,700 of 3,235) |
| Next unit | Warframe batch 34: the next **50** (`python summarise.py next --group warframe/english --n 50`) - 50 kept after the 25-review test (round 432) |
| Backlog | finished: built 347, existing 133, skip 63 (the skips wait on Rico or are jokes) |
| Tree | 1,511 tags |
| Warframe | 1,700 of 3,235 read; 1,535 left; next is batch 34 (50) |
