...
| In-session timer | CronCreate job `6179699b`, `*/20 * * * *` (session-only; dies when the cloud session goes idle - see OPEN-WITH-RICO.md) |
...
| Last unit done | Round 422: Warframe batch 15 (750 of 3,235) |
| Next unit | Warframe batch 16: the next 50 (`python summarise.py next --group warframe/english --n 50`) |
| Backlog | finished: built 347, existing 133, skip 63 (the skips wait on Rico or are jokes) |
| Tree | 1,430 tags |
| Warframe | 750 of 3,235 read (15 of 65 batches); next is batch 16 |
