...
| Last unit done | Round 449: Warframe batch 42, 50 reviews, 0 modes (2,150 of 3,235) |
| Next unit | Warframe batch 43: the next **50** (`python summarise.py next --group warframe/english --n 50`) - 50 kept after the 25-review test (round 432) |
| Backlog | finished: built 347, existing 133, skip 63 (the skips wait on Rico or are jokes) |
| Tree | 1,528 tags |
| Warframe | 2,150 of 3,235 read; 1,085 left; next is batch 43 (50) |
