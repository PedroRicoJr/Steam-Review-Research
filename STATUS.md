...
| Last unit done | Round 447: Warframe batch 40, 50 reviews, 5 modes (2,050 of 3,235) |
| Next unit | Warframe batch 41: the next **50** (`python summarise.py next --group warframe/english --n 50`) - 50 kept after the 25-review test (round 432) |
| Backlog | finished: built 347, existing 133, skip 63 (the skips wait on Rico or are jokes) |
| Tree | 1,526 tags |
| Warframe | 2,050 of 3,235 read; 1,185 left; next is batch 41 (50) |
