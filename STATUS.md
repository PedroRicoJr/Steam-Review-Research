...
| In-session timer | CronCreate job `082ed4b5`, `*/20 * * * *` (session-only; dies when the cloud session goes idle - see OPEN-WITH-RICO.md) |
...
| Last unit done | Round 414 (backlog rows 341-360) |
| Next unit | Round 415: the next 20 `open` rows of `tag-tree-backlog.tsv` |
| Backlog | 112 open, 24 check |
| Tree | 1,347 tags |
