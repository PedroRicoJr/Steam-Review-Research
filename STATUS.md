...
| In-session timer | CronCreate job `0a2686cd`, `*/20 * * * *` (session-only; dies when the cloud session goes idle - see OPEN-WITH-RICO.md) |
...
| Last unit done | Round 409 (backlog rows 241-260) |
| Next unit | Round 410: the next 20 `open` rows of `tag-tree-backlog.tsv` |
| Backlog | 212 open, 24 check |
| Tree | 1,278 tags |
