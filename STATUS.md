...
| Last unit done | Round 446: Warframe batch 39, 50 reviews, 0 modes (2,000 of 3,235) |
| Next unit | Warframe batch 40: the next **50** (`python summarise.py next --group warframe/english --n 50`) - 50 kept after the 25-review test (round 432) |
| Backlog | finished: built 347, existing 133, skip 63 (the skips wait on Rico or are jokes) |
| Tree | 1,521 tags |
| Warframe | 2,000 of 3,235 read; 1,235 left; next is batch 40 (50) |
