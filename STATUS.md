...
| Last unit done | Round 424: Warframe batch 17 (850 of 3,235) |
| Next unit | Warframe batch 18: the next 50 (`python summarise.py next --group warframe/english --n 50`) |
| Backlog | finished: built 347, existing 133, skip 63 (the skips wait on Rico or are jokes) |
| Tree | 1,448 tags |
| Warframe | 850 of 3,235 read (17 of 65 batches); next is batch 18 |
