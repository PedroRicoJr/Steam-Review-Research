...
| Last unit done | Round 433: Warframe batch 26, 50 reviews, 5 modes (1,350 of 3,235) |
| Next unit | Warframe batch 27: the next **50** (`python summarise.py next --group warframe/english --n 50`) - 50 kept after the 25-review test (round 432) |
| Backlog | finished: built 347, existing 133, skip 63 (the skips wait on Rico or are jokes) |
| Tree | 1,487 tags |
| Warframe | 1,350 of 3,235 read; 1,885 left; next is batch 27 (50) |
