...
| In-session timer | CronCreate job `4c313590`, `*/20 * * * *` (session-only; dies when the cloud session goes idle - see OPEN-WITH-RICO.md) |
...
| Last unit done | Round 415 (backlog rows 361-380) |
| Next unit | Round 416: the next 20 `open` rows of `tag-tree-backlog.tsv` |
| Backlog | 92 open, 24 check |
| Tree | 1,359 tags |
