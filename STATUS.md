...
| In-session timer | CronCreate job `60640176`, `*/20 * * * *` (session-only; dies when the cloud session goes idle - see OPEN-WITH-RICO.md) |
...
| Last unit done | Round 404 (backlog rows 141-160) |
| Next unit | Round 405: the next 20 `open` rows of `tag-tree-backlog.tsv` |
| Backlog | 312 open, 24 check |
| Tree | 1,218 tags |
