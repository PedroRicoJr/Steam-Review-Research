...
| In-session timer | CronCreate job `a570f43e`, `*/5 * * * *` (session-only; dies when the cloud session goes idle - see OPEN-WITH-RICO.md) |
...
| Last unit done | Round 432: Warframe batch 25, 25 reviews - test 2 of 2; batch size back to 50 (1,300 of 3,235) |
| Next unit | Warframe batch 26: the next **50** (`python summarise.py next --group warframe/english --n 50`) - 50 kept after the 25-review test (round 432) |
| Backlog | finished: built 347, existing 133, skip 63 (the skips wait on Rico or are jokes) |
| Tree | 1,482 tags |
| Warframe | 1,300 of 3,235 read; 1,935 left; next is batch 26 (50) |
