...
| Last unit done | Round 454: Warframe batch 47, 50 reviews, 1 mode (2,400 of 3,235) |
| Next unit | Warframe batch 48: the next **50** (`python summarise.py next --group warframe/english --n 50`) - 50 kept after the 25-review test (round 432) |
| Backlog | finished: built 347, existing 133, skip 63 (the skips wait on Rico or are jokes) |
| Tree | 1,533 tags |
| Warframe | 2,400 of 3,235 read; 835 left; next is batch 48 (50) |
