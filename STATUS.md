...
| In-session timer | CronCreate job `a6fcef1d`, `*/20 * * * *` (session-only, re-created 2026-09-24 after a restart, expires 2026-10-01) |
...
| Last unit done | Round 402 (backlog rows 101-120) |
| Next unit | Round 403: the next 20 `open` rows of `tag-tree-backlog.tsv` |
| Backlog | 352 open, 24 check |
| Tree | 1,196 tags |
