...
| In-session timer | CronCreate job `e4544ab4`, `7,37 * * * *` (re-created 09:45 UTC after a session restart) (auto-expires after 7 days; the backstop re-creates it) (session-only; dies when the cloud session goes idle - see OPEN-WITH-RICO.md) |
...
| Last unit done | Round 459: Warframe batch 52, 50 reviews, 0 modes (2,650 of 3,235) |
| Next unit | Warframe batch 53: the next **50** (`python summarise.py next --group warframe/english --n 50`) - 50 kept after the 25-review test (round 432) |
| Backlog | finished: built 347, existing 133, skip 63 (the skips wait on Rico or are jokes) |
| Tree | 1,535 tags |
| Warframe | 2,650 of 3,235 read; 585 left; next is batch 53 (50) |
