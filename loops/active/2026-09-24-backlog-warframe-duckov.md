...
**Started 2026-09-24 on Rico's word.** Runs every 30 minutes (Rico, 2026-09-25; 20, then 10, then 5 after the batch-size test, then 30 from 08:3x UTC after the usage test). How loops work in general:
