...
- 177125124: "top 3 favourite games of all time despite gearbox existing"; 177611446: a jab at the owner's named head - both on `ownership.unknown`.
...
## Notes - round 383 (Warframe batch 1)

- Batch 1 of Warframe, 2013-03 to 2013-06: 50 read, 0 excluded, 125 bullets, 32 on `.unknown` modes (26%). 20 of 50 carry an edit date; two are multi-dated inside the text (210959 has 2013, 2017 and 2019 blocks; 2492696 has 2013 and 2018), both flattened onto the created month, which is still open with Rico.
- **Precedent kept:** "it is free" as praise homes on `publishing.price.fair`, as it did for Terminull Brigade ("a decent game for free"). Six sightings in this batch alone (734078, 3896431, 5322675, 5720986, 1803160 and 535568 by way of `best-in-its-category`). If Rico wants the free-to-play case split from a paid fair price, the count is easy to recover from that mode.
- **One sighting, no home:** a free player is capped on how many warframes they can own (four slots) and paying lifts the cap - 2492696. Homed on `publishing.monetisation-practice.unknown`. Not the same as `the-cap-stops-you-short` (a progression ceiling) or `pay-affects-play` (an advantage in play). The DRG Rogue Core slots line (232360843) is in-game currency, so it does not count as a sighting. Build on the second.
- **One sighting, no home:** buying the item outright is the only way around a hard grind, and the reviewer will not pay - 6449334. Homed on `publishing.monetisation-practice.unknown`. Build on the second.
- **One sighting, no home:** updates arrive so often that the patching ate the session ("every other minute was an update", 6780550, thumbs-up). Homed on `live-ops.update-cadence.unknown`. Joke-shaped; build only if a second review says it straight.
- **One sighting, no home:** a required separate account that the reviewer says is painless (6074990). `account-or-platform-gate` is a complaint, so the praise went to `engineering.access.unknown`. Build a neutral or positive twin on the second sighting.
- **One sighting, no home:** the reviewer warns players with a game addiction away from the game (6449334). The bullet homes on `keeps-pulling-you-back`; the warning itself has no mode. `accessibility.addiction` is about depicted addiction, not the game's own pull, so it is not the home.
- **Parser defect still open:** the four accessibility subjects that share one heading (`accessibility.phobia` · `.trauma` · `.addiction` · `.self-harm`, round 111) still have no modes in the card, so their six shared modes cannot be written. Same build_card() defect as before; waiting on Rico.
- Running tallies opened for this game: "space ninjas" 4 (3549795, 5325088, 1803917, 1738344 by way of "ninja"); Mass Effect named 3 (210959, 1738344, 5303306); Digital Extremes or Steve Sinclair named 3 (3854627, 2492696 x2).

## Notes - round 384 (Warframe batch 2)

- Batch 2 of Warframe, 2013-06 to 2013-08: 50 read, 0 excluded, 110 bullets, 26 on `.unknown` modes. 22 of 50 carry an edit date; one is multi-dated inside the text (6355630: 2013 line plus a 2026 block), flattened onto the created month. One review (2069152) was edited today, 2026-09-14, the day of the pull.
- **Built:** `publishing.monetisation-practice.paying-only-shortens-the-grind` (~). Fourth sighting across two games: Terminull Brigade 201817142 (re-homed off `pay-affects-play`, which is an advantage over other players), Warframe 6449334 (batch 1, re-homed off `monetisation-practice.unknown`), 830179 (boosters) and 2263653 ("not needed but it sure makes things easier"). The round-383 note "buying the item outright is the only way around a hard grind" closes into this mode. Tree 1,088 to 1,089.
- **Slot cap, still one sighting** (2492696, round 383). Nothing in this batch.
- **One sighting, no home:** the reviewer lost access to their own account after a thousand hours and money spent (804280, thumbs-down). Homed on `engineering.access.account-or-platform-gate`, which is the nearest complaint, but that mode is about a required account annoying, not an account that stops working. Build on the second sighting.
- **One sighting, no home:** no trading system (1882353, 2013). Homed on `community.social-features.unknown`. Warframe later got a player market, so later reviews may say the opposite; watch for it.
- **One sighting, no home:** the clan or guild system praised as a thing to build and manage (3921375). Homed on `community.social-features.unknown`. 6920334 says clan-locked weapons are reachable in a two-player clan (homed on `unlock-pace.unknown`). If a third review talks about clans as a system, build.
...
## Notes - round 386 (Warframe batch 4)

- Batch 4 of Warframe, 2013-11 to 2014-01: 50 read, 0 excluded, 119 bullets, 29 on `.unknown` modes. 11 of 50 carry an edit date; two are multi-dated inside the text (7659727 has 2013, 2016, 2019 and 2022 blocks - four verdicts in one review; 7718099 has 2013 plus 2016), flattened onto the created month.
- **Built:** `community.social-features.the-clan-hall-is-worth-building` (+), second sighting: 3921375 (batch 2, re-homed off `.unknown`) and 8722266. Tree 1,093 to 1,094. The two other clan lines (6920334, 776593) say different things and stay on `.unknown`.
- **Second sighting on an existing mode:** `community.moderation.heavy-handed` - 4363203 (batch 2) and 7718930 ("chat moderation being some of the worst, over-reaching garbage I've ever seen"). Two in 200, both from long-tenure players.
- **One sighting, no home:** support is unhelpful most of the time, by hearsay from other players, while the reviewer's own one contact was fine (7718930). Homed on `community.developer-communication.unknown`; neither `support-request-went-unanswered` nor `support-replied-with-a-form-letter` fits a general verdict on support. Build a general "support does not help" mode on the second.
- **One sighting, no home:** the PvP mode (Conclave) has no players while the PvE side is full (7660006). Homed on `community.population.unknown`. With 2435922 (round 385, early nodes empty) that is two population-by-place lines, each about a different place. If a third names an empty mode, build "one mode has no players".
...
## Notes - round 388 (Warframe batch 6)

- Batch 6 of Warframe, 2014-04 to 2014-06: 50 read, 0 excluded, 106 bullets, 30 on `.unknown` modes. 10 of 50 carry an edit date; one is multi-dated inside the text (10386904: 2014 review, an edit about end game, then a Plains of Eidolon block), flattened onto the created month. No tree change.
- **One sighting, no home:** power creep - old gear loses relevance as newer, stronger gear arrives (10487208). Homed on `game-design.power-balance.unknown`. The Risk of Rain 2 "DLC power creep" line went to `pay-affects-play` because money was involved; this one is time, not money. Build on the second.
- **One sighting, no home:** the game adds strangers to your session when you start alone (10386859, said as praise). Homed on `engineering.matchmaking.unknown`.
- **One sighting, no home:** the reviewer wants a purpose for the built character beyond more levelling - "player-to-player recognition" for the time invested (10209689). Homed on `nothing-left-to-chase` for the first half; the recognition half has no mode and is not the same as `cosmetic-rewards.nothing-to-show-for-it`, which is about visible rewards, not about other players seeing them. Build on the second.
- **Timegates, fourth sighting** (9828353, 10487208; earlier 4965900, 8611993), all on `gated-behind-real-world-time`. That mode's definition says "a weekly reset, a daily cap"; Warframe's version is a crafting timer that money skips. The mode holds it, but the definition could name the crafting timer. Not edited; noting for the findings.
...
## Notes - round 390 (Warframe batch 8)

- Batch 8 of Warframe, 2014-09 to 2014-11: 50 read, **1 excluded** (13047017, a pancake recipe), 148 bullets, 25 on `.unknown` modes. 10 of 50 carry an edit date; none is multi-dated inside the text.
- **Built:** `art.fidelity.the-picture-is-blurry` (-), fourth sighting across three games, every one parked on an `.unknown`: DRG Rogue Core 226257078 and Warframe 9010933 (round 387) re-homed off `art.fidelity.unknown`; Redfall 221349897 re-homed off `art.visual-direction.unknown`; Warframe 12306429 this batch. Tree 1,097 to 1,098.
- **Bare "not pay to win" homes on `cosmetic-only`**, whose definition is "paid extras never affect play" - the same claim. Three this batch (12112550, 12600481, 12958898), following 8611993 (round 386). No new mode.
- **One sighting, no home:** the mid-game story reveal removes the stakes and the fantasy (12111253, the operator reveal). Homed on `narrative.world-and-setting.breaks-its-own-fiction`, which is about additions contradicting the world; a reveal that deflates the fiction is close but not the same. Build "the twist ruined it for me" on the second.
- **One sighting, no home:** big updates are rare but worth the wait (12192077). Neither `steady-stream` nor `too-slow`; homed on `update-cadence.unknown`.
- **Second sighting on `built-for-another-platform`** for this game: 12306429 ("must be for console players on big tv screens"); the first was 7718099's controls line in round 386, which went to `the-default-layout-is-awkward`. Holds.
- **Two summaries record hateful text without repeating it** this batch: 12835365 (an antisemitic slur for one faction, recorded on `world-and-setting.unknown` as "a slur") - the third such summary in 400 (7335200, 7457225 before).
- **Counts on the Warframe-built modes** at 400: `paying-only-shortens-the-grind` 14, `the-player-market-works` 10, `the-clan-hall-is-worth-building` 8, `what-you-can-own-is-capped-unless-you-pay` 5, `timed-events-give-a-reason-to-log-in` 4, `the-shop-charges-far-too-much` 3 (+2 Terminull), `drifted-from-what-it-was` 2, `locked-out-of-my-own-account` 3, `carries-the-reviewers-referral-link` 2.
- Running tallies: `price.fair` for "it is free" 9 more (54 in 400); "space ninjas" 8 more (56 in 400); Mass Effect 0 (11 in 400); Dark Sector 1 (6 in 400); Monster Hunter, Team Fortress 2, Splinter Cell 1 each; the studio or a staff member named 3 (28 in 400); `keeps-pulling-you-back` 9 this batch.

## Notes - round 391 (Warframe batch 9)

- Batch 9 of Warframe, 2014-11 to 2015-02: 50 read, 0 excluded, 145 bullets, 21 on `.unknown` modes. 10 of 50 carry an edit date; one is multi-dated inside the text (14373730: a 2026 positive over a 2025 negative over a 2015 negative, all kept in the text; nineteen bullets, the most in the run), flattened onto the created month. No tree change.
- **"What Destiny should have been" - three sightings this batch** (13172108, 13384501, 14265605), all on `beats-its-rivals`. The comparison the 2014 reviewers reach for is Destiny (launched 2014-09); the 2013 reviewers reached for Mass Effect 3. Worth a line in the findings: the rival named tracks what launched that year.
- **One sighting, no home:** platinum cannot be earned from the game itself, only bought or traded for, and the reviewer wants a free trickle (13383901). Homed on `monetisation-practice.unknown`. It is the inverse of `currency-earnable-by-playing`, which 776269 used for the trade route; this reviewer does not count trading. Build the negative twin on the second.
- **One sighting, no home:** things that should have been free, like colour palettes, are charged for (13746977). Homed on `monetisation-practice.unknown`; `what-was-free-is-now-paid` is about something taken away, `free-items-still-sold-through-a-shop` is about the shop selling what the game also gives. Build on the second.
- **One sighting, no home:** the trade chat is full of scammers (14133119). Homed on `player-conduct.unknown`; the corpus's other "scammer" lines are about a studio or in-world rats. The negative side of `the-player-market-works`; build on the second.
- **One sighting, no home:** veterans refuse to help new players and block anyone who asks (14373730, the 2015 layer). Homed on `community.culture.unknown`, the inverse of `welcoming-to-newcomers`, which the same game has 6 times. Build on the second.
- **One sighting, no home:** the download and update servers are slow and the launcher freezes verifying the cache (14266703). Homed on `will-not-start-at-all` because the reviewer never got past the launcher. With 6780550 (round 383, "every other minute was an update") that is two patching complaints of different shapes.
- **Third sighting on `community.moderation.heavy-handed`** (14133119: forum and game bans for no good reason, "big brother"). Three in 450, each from a different year (2014-written, edited 2018; 2024; 2020).
- **Counts on the Warframe-built modes** at 450: shortens-the-grind 22, player market 12, clan hall 8, slot cap 8, timed events 4, shop charges too much 6 (+2 Terminull), locked out 3, drifted 2, referral 2, blurry 2 (+2 elsewhere).
- Running tallies: `price.fair` for "it is free" 4 more (58 in 450); "space ninjas" 6 more (62 in 450); Destiny 3, Mass Effect 1 (12 in 450), Monster Hunter 1; the studio or a staff member named 4 (32 in 450); `keeps-pulling-you-back` 8; two summaries record antisemitic content without repeating it (13885375; 4 hateful-content summaries in 450).

## Notes - round 392 (Warframe batch 10)

50 read (2015-02 to 2015-04), 110 bullets, 0 excluded, 12 edited later. Running total 500 of 3,235. 42 up / 8 down. 30 bullets on an `.unknown` (19 of them bare praise). Tree 1,098 -> 1,102.

- **Built (four modes, each on its second or third sighting):**
  - `publishing.monetisation-practice.the-premium-currency-cannot-be-earned-by-playing` (-): 13383901 (round 390, re-homed off `monetisation-practice.unknown`) + 14471201. The negative twin of `currency-earnable-by-playing`.
  - `publishing.monetisation-practice.colours-and-basic-cosmetics-cost-real-money` (-): 13746977 (round 391, re-homed off `paying-only-shortens-the-grind`) + 14471201, with Space Marine 2 192831791 (round 308) staying on `mtx-in-premium-game` because that game is premium. The complaint side of `cosmetic-only`.
  - `game-design.replayability.warns-that-it-takes-over-your-life` (-): 6449334 (round 383, re-homed off `keeps-pulling-you-back`) + 15256549, a 600-word satirical spiral that ends "uninstall now and save yourself". Bare "warning: addictive" praise (ARC Raiders 209506499, 209506850; RoR2 216646045) stays on `keeps-pulling-you-back`. `accessibility.addiction` is depicted addiction, so not the home.
  - `live-ops.update-cadence.updating-eats-the-play-session` (-): 6780550 (round 383, re-homed off `update-cadence.unknown`) + 15393564, with 14266703 (round 391) staying on `will-not-start-at-all` because its launcher also freezes.
- **One sighting, no home:** difficulty by squad size - "one player difficult, two challenging, three ok, four too easy" (14582960). Homed on `difficulty-tuning.unknown`. The positive `co-op-design.scales-to-the-number-of-players` exists; this is its negative twin. Build "difficulty does not scale with the squad" on the second.
- **One sighting, no home:** "a friend told me it was cool and free, so I got it" (14471522). Homed on `new-player-experience.unknown`. `marketing.discovery` has an outside-reward mode but no word-of-mouth mode. Build on the second.
- **One sighting, no home:** the game goes "from fun to boring to fun" in a loop (14471201). Homed on `replayability.unknown`.
- **One sighting:** the Steam build does not run but the studio's own launcher does (14700535). Homed on `will-not-start-at-all` with the detail. If a second says the same, `platform-support.better-elsewhere` may need a "the non-Steam build works" reading.
- **Second sighting of "wants a PvP mode"** (14582644, 15147860) both homed on `modes.expected-mode-missing`, which fits. With 7660006 (Conclave empty) and 776593 (PvP locked behind gear) that is four PvP lines in 500, each a different complaint.
- **Existing modes used for the first time in this run:** `new-player-experience.stuck-with-the-worst-starter` (14784090: the starter bow cannot be upgraded until Saturn), `game-feel.movement.unreliable` (14784090: pillars not registered as runnable surfaces), `game-feel.camera.no-choice-of-view` (14784367: asks for first person), `ui-ux.cannot-skip-what-the-game-plays-at-you` (15391962: story cutscenes replay after a failed quest), `promise-vs-reality.claim-was-untrue` (14784090: "not the ninja-stealth game it claims to be").
- **Third Warframe blur line** (14582960 "too much blur") on `the-picture-is-blurry`, built in round 390. Now 3 in Warframe + 2 elsewhere.
- **"Canadian companies"** as a sigh (15393564) went on `developer-communication.unknown`; a swipe at the studio's country is a fact about the reviewer, not the game. Not a mode.
- **Counts at 500, by script (grep over raw/warframe/english/summaries, files or bullet lines as stated):** `price.fair` 47 bullets; files that say "ninja" 57, "space ninja" 31; `paying-only-shortens-the-grind` 24 files (one moved off to colours this round); `locked-out-of-my-own-account` 4 files; `expected-mode-missing` 4 files; files naming Destiny 5. The hand-kept running tallies in rounds 383-391 ("it is free" 58 in 450, "space ninjas" 62 in 450) do not match these script counts; the script counts are the ones to trust, and the tallies are dropped from here on.
- **Multi-dated reviews flattened this batch:** 15393564 (2015 update complaint, 2019 grind complaint), 14696851 (2015 created, 2020 edit; text reads as the 2020 view).

## Notes - round 393 (Warframe batch 11)

50 read (2015-04 to 2015-07), 136 bullets, 0 excluded, 10 edited later. Running total 550 of 3,235. 43 up / 7 down. 28 bullets on an `.unknown` (12 of them bare praise). Tree 1,102, no change.

- **`warns-that-it-takes-over-your-life` (built last round) took two more in its first batch:** 16425752 ("pay to win - not money but life; it sucks out your health, fortune, dream and passion") and 16817132 ("at 1,200 hours I uninstalled the game so I would stop playing it"). 4 files in 550. Both thumbs are the opposite of what the line says (one down, one up), so the thumb settles nothing here.
- **One sighting, no home:** in PvE, gear alone decides whether the enemies one-shot you or you one-shot them; "either you cannot succeed or you cannot have fun" (15627119). Homed on `power-balance.unknown`. `the-gear-gap-decides-the-fight` is PvP by definition; `progression-outgrows-the-challenge` covers only the second half. Build "mod power, not play, decides the fight" on the second.
- **One sighting, no home:** the grind cycle "takes precedence over the gameplay itself" (15627119). Homed on `grindy`, which is close but says too much repetition, not that the loop displaces play. Build on the second.
- **Second sighting of the controls needing a rebind before the game works** (16631895: hated it on PC and on Xbox until they bound the whole game to a Naga mouse; 9210860 round 388 preferred a controller). Both on `the-default-layout-is-awkward` / `controls.unknown`; a mode that says "the default layout hides the game" is not yet needed - the awkward-layout mode carries it.
- **A 20-year suspension** (15974371: "account suspended until 2035") went on `moderation.heavy-handed`; a ban claimed to be sales-driven (16425752: "banning players with high platinum inventories to help sales") went there too. 5 files in 550.
- **The "no endgame" line** (15626929: nothing hard enough for the best players with the best gear) homed on `too-easy`, with `nothing-left-to-chase` checked and rejected - that mode is about goals running out, this is about challenge running out.
- **A jab at a named staff member's health** (16425752) is recorded as a jab, not repeated, on `developer-communication.unknown`. Same rule as the hateful-content lines.
- **Counts at 550, by script (files under raw/warframe/english/summaries):** `thumb-contradicts-text` 7; `carries-the-reviewers-referral-link` 3; `listens-and-acts` 10; `open-about-what-it-is-doing` 5; files naming Destiny 7, Mass Effect 11.
- **Multi-dated reviews flattened this batch:** 16425752 (2015 created, rewritten in 2023 as an obituary), 15627119 (2015 created, 2020 edit that names open worlds and liches), 16630435 (2015 with a later update paragraph), 16817132 (2015 created, 2016 edit that ends at 1,200 hours).

## Notes - round 394 (Warframe batch 12)

50 read (2015-07 to 2015-09), 149 bullets, 0 excluded, 15 edited later. Running total 600 of 3,235. 46 up / 4 down. 33 bullets on an `.unknown` (20 of them bare praise). Tree 1,102 -> 1,104.

- **Built (two modes, each on its third sighting):**
  - `community.culture.veterans-will-not-help-newcomers` (-): 14373730 (round 391, re-homed off `culture.unknown`), 17434294 ("unwilling to help new people, more interested in trolling the chat"), 17820339 ("open raids only want high ranks; they stay in their own bubble"). The negative twin of `welcoming-to-newcomers`, which Warframe carries far more often; the count between the two is a findings line.
  - `game-design.progression.unlock-pace.you-grind-for-gear-you-will-never-use` (-): 8236558 (round 386) and 11124722 (round 388), both re-homed off `power-balance.some-options-are-useless` as their notes asked, plus 17934084 ("the only reason to use bad weapons is to feed mastery rank; mastery fodder").
- **One sighting, no home:** each major update is a "content island" - a hub with NPCs to befriend, unrelated to the last one, with little reason to return once emptied (17323915). Homed on `patch-quality.unknown`. Not `content-thin` (there is plenty) and not `the-updates-add-to-what-i-did-not-come-for` (the reviewer wanted them). Build on the second.
- **One sighting, no home:** the story is written intentionally cryptic so players speculate between slow seasonal updates, and it works (17323915). Homed on `story.unknown`. Neutral as stated; build only if a second calls it a loss or a gain.
- **One sighting, no home:** the trading system itself is bad - prices swing within a day, only decent gear trades (17820339). Homed on `social-features.unknown`. The negative twin of `the-player-market-works`; with 1882353 ("no trading system", round 383) that is two different complaints about the market, not two sightings of one. Build on a second that says the market works badly.
- **One sighting:** a game "showed up in my Steam queue" as the way in (18049800). Homed on `discovery.unknown`. With 14471522 ("a friend told me", round 392, `new-player-experience.unknown` - should have been `discovery.someone-recommended-it`, which exists; re-homed below) that is two discovery lines in 600.
- **A protest vote with nothing about the game** (17683946: "Hong Kong and Taiwan are parts of the People's Republic of China") went on `thumb-is-a-protest-vote`, not excluded: it is a verdict on the studio, cast as a review.
...
## Notes - round 397 (single-sighting backlog 1)

**Rule C (Rico, 2026-09-24): build a mode on the first sighting, and build the parked backlog before Warframe batch 15.** The backlog was inventoried from this file on 2026-09-24: 840 notes, checked against the summary files. 543 still have a bullet on the tag it was parked on; 472 of those are open to build. The worklist is `tag-tree-backlog.tsv` (one row per note, with a status). Rows skipped by rule: 24 jokes, 21 that need a new subject (Rico), 2 Rico ruled on. 24 rows are marked "check": the gap says closed, but the bullet is still on its parked tag.

Backlog rows 1-20 read this round. Tree 1,104 -> 1,119 (15 modes). 22 bullets re-homed across 10 games. dircheck 0; unfitted 0 in every game touched.

- **Built (15):** `marketing.reputation.judges-the-studio-by-its-country` (-, Redfall 215496457, gap 74); `accessibility.memory-and-attention.a-player-with-a-named-condition-says-it-works` (+, Back 4 Blood 232385617, gap 323); `narrative.story.told-during-the-fighting-so-it-is-lost` (-, Space Marine 2 189003013); `game-design.game-feel.controls.aim-assist-helps` (+, Terminull Brigade 202527914, gap 138); `accessibility.vision.flashing-that-endangers-photosensitive-players` (-); `accessibility.vision.the-motion-sickness-options-miss-some-of-it` (-, Remnant II 152602378); `game-design.ai-teammates.a-living-bot-does-not-keep-the-mission-alive` (-, Space Marine 2 179603532); `art.atmosphere.too-many-enemies-to-keep-the-mystery` (-, Redfall 165222785, gap 71); `game-design.world-interaction.the-hub-feels-empty` (-); `game-design.ui-ux.the-game-outlines-every-enemy-for-you` (-, Aliens: Fireteam Elite 223871859, closes gap 308); `art.character-design.embarrassing-to-have-on-screen-around-others` (-, Terminull Brigade 201520607, gap 124); `art.character-design.a-known-creature-does-not-look-like-itself` (-, Aliens: Fireteam Elite 224924454, gap 299); `game-design.progression.build-and-customisation.the-options-for-one-gender-are-poor` (-, Aliens: Fireteam Elite 192686658, gap 277); `game-design.progression.cosmetic-rewards.the-outfits-make-you-look-silly` (-, ARC Raiders 214041904, gap 336); `art.effects-and-gore.too-little-gore` (-, Aliens: Fireteam Elite 202170940, gap 282).
- **Same-round re-homes found by findphrase:** the flashing mode took four - Space Marine 2 182195498 and Risk of Rain 2 152614012 (both off `accessibility.vision.unknown`), and Risk of Rain 2 70857873 ("the explosions can give you a seizure") and 171193612 ("pick it up if you have epilepsy", a sarcastic warning), both off `effects-block-your-view`. Risk of Rain 2 63128830 ("just an epileptic crisis") and the two Remnant II final-boss lines stay where they are: they describe chaos on screen, not a health risk. The empty-hub mode took three - Deep Rock Galactic: Rogue Core 226234220 (off `art.atmosphere.falls-flat`) and 226263607 (off `production.content-amount.too-little`), and Back 4 Blood 105491192 (off `level-design.badly-laid-out`). Rogue Core 226248906 stays on `badly-laid-out`: its line names hallways that lead into walls.
- **Existing modes fit (4):** 117387804 (captions inaccurate) moved to `accessibility.hearing.the-subtitles-do-not-match-the-speech`, built after gap 92 was written. 204978219 ("a dogsbody while the AI does the fighting") moved to `ai-teammates.bots-play-it-for-you`. 221761266 (the console war killed it) stays on `judged-unfairly`: the war is the cause, and the tree records the feeling (Rico, 2026-09-10). 108065081 (branding) stays on `look-undersells-the-game`, whose definition it matches.
- **Gap 308's second sighting** (233444134, "a yellow silhouette ... looks like ass") stays on `art.visual-direction.off-putting-look`: what the reviewer felt is that it is ugly.

## Notes - round 398 (single-sighting backlog 2)

Backlog rows 21-40 read. Tree 1,119 -> 1,133 (14 modes). 21 bullets re-homed across 9 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 432.

- **Built (14):** `narrative.story.cutscenes-are-well-made` (+, Redfall 223348343, gap 80, the inverse of `cutscenes-are-badly-made`); `art.visual-direction.the-style-looks-like-a-budget-choice` (-, The Anacrusis 130354249, gap 99); `audio.mixing.the-opening-is-far-louder-than-the-game` (-, Terminull Brigade 203081549 and 214212484, gaps 153 and 166); `audio.mixing.opens-at-a-comfortable-volume` (+, Remnant II 155513808); `audio.mixing.the-sound-plays-in-one-ear-only` (-, Remnant II 229855395); `audio.music.jumps-between-styles-with-no-theme` (-, The Anacrusis 207628501, gap 117); `audio.music.cuts-in-and-out` (-, Remnant II 143173256); `audio.music.best-played-with-your-own-music` (+, Aliens: Fireteam Elite 188826495, gap 274); `audio.sound-effects.the-world-sounds-alive` (+, Redfall 138780276, gap 66); `audio.sound-effects.a-sound-wears-you-down` (-, Aliens: Fireteam Elite 197325200, gap 284, and Remnant II 145398201); `audio.sound-effects.sounds-great` (+, Risk of Rain 2 224994808); `community.developer-communication.will-not-say-where-it-used-ai` (-, ARC Raiders 208435714, closes gap 327); `audio.voice-performance.should-have-paid-voice-actors` (-, ARC Raiders 220131803, gap 334); `audio.voice-performance.the-players-lines-are-the-only-ones-unvoiced` (-, Remnant II 165433529).
- **Same-round re-homes found by findphrase:** own music - Risk of Rain 2 71197260 (off `audio.music.unknown`) and 182194512, and Space Marine 2 175206594 (both off `review.positive.unknown`). ARC Runner 174563681 and Risk of Rain 2 78037782 put on a playlist because the score bores them, so they stay on `forgettable-or-annoying`. One ear - The Anacrusis 130364645 (ducking switched to mono in the right ear, off `mixing.unknown`). A sound wears you down - Rogue Core 226904543 (a terminal "grating from walking past it", off `sounds-out-of-place`).
- **Stayed where they were (3):** Risk of Rain 2 161302917 ("lights and colours", nothing either way); ARC Raiders 216643504 stays on `the-voices-are-generated-and-it-shows` (the line ends on the result sounding bland); Remnant II 228040776 (the backpack cannot come off) fits `cannot-change-how-you-look`.
- **Skipped (1):** Risk of Rain 2 93823566 - the "first game had X" tally is open with Rico.

## Notes - round 399 (single-sighting backlog 3)

Backlog rows 41-60 read. Tree 1,133 -> 1,150 (17 modes). 17 bullets re-homed, 3 new bullets, 3 bullet texts rewritten; 20 summary files across 8 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 412.

- **Built (17):** review - `.tells-other-reviewers-how-to-vote` (Helldivers 2 165433162, closes gap 21), `.the-thumb-is-aimed-at-other-players` (Helldivers 2 171715487, closes gap 27), `.says-few-people-will-read-it` (Helldivers 2 165438427), `.the-thumb-is-encouragement-not-a-verdict` (Zombie Girl 148210236, gap 319). community.culture - `.players-sorted-themselves-into-groups` (+, ARC Raiders 209803514, gap 333), `.the-players-map-the-secrets-together` (+, Remnant II 144280701), `.a-place-to-make-friends` (+, Risk of Rain 2 212816313). community.developer-communication - `.stopped-punishing-criticism` (+, Helldivers 2 165437435, closes gap 19), `.only-the-moderators-answer` (-, Terminull Brigade 201948956, gap 139), `.no-way-to-reach-the-studio` (-, 201940388, gap 140), `.hid-the-player-count` (-, 203730584, gap 149), `.looks-after-one-region-only` (-, 227205592, gap 177), `.denies-a-bug-players-can-show` (-, 219828133, gap 178), `.no-remedy-for-a-purchase-that-went-wrong` (-, 228789443, gap 180), `.not-open-about-its-plans` (-, Aliens: Fireteam Elite 100234073, gap 199), `.visibly-working-on-the-problems` (+, Risk of Rain 2 181184333). community.moderation - `.left-unmoderated` (-, Terminull Brigade 224900562, gap 179).
- **Second sighting found by findphrase:** Risk of Rain 2 56724222 ("this will get buried under the overwhelmingly positive reviews") moved off `review.unknown` onto `.says-few-people-will-read-it`.
- **New bullets and splits (the review said two things on one line):** 171715487 gains a bullet for its thumb ("super traitors deserve only super negative reviews"); its accusation stays on `the-fanbase-puts-me-off`. 108031523's feedback line is split: praise stays on `listens-and-acts`, the ledger goes to the existing `review.kept-as-a-ledger-of-what-the-studio-fixed` (gap 86). 224900562's line is split: silence stays on `went-silent-after-a-bad-launch`, the unchecked scam posts go to `.left-unmoderated`.
- **Re-homed to an existing mode:** ARC Raiders 217295295 (a thirty-day ban on a streamer's word, no investigation, gap 338) moved from `players-know-the-staff-by-name` to `community.moderation.heavy-handed`. **Its bullet named a staff member and ended "should be fired"; rewritten to "a jab at the named staff member"** under the jab rule.
- **Skipped (1):** Risk of Rain 2 83687960 ("Gearbox slightly cares") - the publisher-communication split is open with Rico.
- **Tooling:** `scripts/rehome_helper.py` gains `rehome_bullet()` (re-home by text when a review has two bullets on one tag) and `set_bullet_text()` (split a bullet, or remove a name from a jab). Both assert exactly one match.

## Notes - round 400 (single-sighting backlog 4)

Backlog rows 61-80 read. Tree 1,150 -> 1,167 (17 modes). 19 bullets re-homed, 1 bullet split; 20 summary files across 10 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 392.

- **Built (17):** community.developer-communication - `.the-developers-play-with-us` (+, Warframe 776269, the positive twin of `the-studio-does-not-play-its-own-game`), `.support-is-unhelpful-in-general` (-, Warframe 7718930), `.feedback-only-through-an-outside-chat-app` (-, Aliens: Fireteam Elite 98587485, gap 185). community.player-conduct - `.players-ambush-the-objective` (-, ARC Raiders 232925246), `.pvp-opponents-feel-like-bots` (-, Space Marine 2 195506351), `.a-cheater-can-damage-your-save` (-, Remnant II 206126223), `.scammers-work-the-trading` (-, Warframe 14133119). community.playing-with-friends - `.a-keepsake-of-someone-gone` (+, Helldivers 2 178129695, closes gap 28), `.fills-in-for-couch-co-op` (+, Aliens: Fireteam Elite 221215129, gap 295). community.population - `.most-owners-never-played-it` (-, The Anacrusis 176679912, gap 116), `.only-busy-at-certain-hours` (-, Aliens: Fireteam Elite 166889307, gap 261), `.thinner-than-hoped-but-playable` (~, Risk of Rain 2 149731343), `.the-early-areas-are-empty` (-, Warframe 2435922), `.one-mode-has-no-players` (-, Warframe 7660006, Conclave). community.social-features - `.the-group-finder-works` (+, Terminull Brigade 201801824, gap 130), `.the-group-finder-covers-only-some-modes` (-, 202880237, gap 145). game-design.progression.build-and-customisation - `.two-choices-together-leave-you-helpless` (-, Aliens: Fireteam Elite 146693230, gap 249).
- **Direction faults fixed by the build:** 202880237 ("the group-finding tool works for only two of the five modes") was a complaint sitting on the + mode `good-tools-for-coordinating`. 146693230's warning about a card-and-weapon combination sat inside a + bullet on `the-review-teaches-you-how-to-play`; the line is split, and the teaching half stays.
- **Same-round re-homes found by findphrase:** Terminull Brigade 224900562 ("the support team is useless") moved off `support-request-went-unanswered` onto `.support-is-unhelpful-in-general`; Deep Rock Galactic 207416054 ("a faithful embodiment of classic couch co-op") moved off `marketing.positioning.unknown` onto `.fills-in-for-couch-co-op`. The three split-screen requests stay on `modes.expected-mode-missing`.
- **Existing modes fit (3):** The Anacrusis 219373901 (Discord members "annoyed by a different opinion", gap 120) moved to `community.culture.the-fanbase-puts-me-off`. 111246111 (subscription players play badly, gap 83) stays on `unskilled-or-careless`: the subscription is the cause, and the tree records the feeling. 222733459 (public games feel like a shooter, private ones like a story, gap 296) stays on `poor-with-strangers`.
- **Warframe 7718930** keeps its other bullet ("the team is carried by a few people") on `developer-communication.unknown`; it was not in this row.

## Notes - round 401 (single-sighting backlog 5)

Backlog rows 81-100 read. Tree 1,167 -> 1,183 (16 modes). 21 bullets re-homed; 21 summary files across 10 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 372.

- **Built (16):** community.social-features - `.only-a-player-run-chat-fills-a-lobby` (-, Aliens: Fireteam Elite 100147455, closes gap 206: built as a sibling rather than renaming the studio-chat mode, which would have moved every earlier bullet), `.no-trading-between-players` (-, Warframe 1882353), `.the-player-market-works-badly` (-, Warframe 17820339), `.hard-to-get-into-a-clan` (-, Warframe 776593). `game-design.world-interaction.no-home-base-that-shows-your-progress` (-, ARC Raiders 223339463, gap 343). community.user-created-content - `.the-tools-taught-me-to-make-games` (+, The Anacrusis 197189537, closes gap 119), `.even-mods-did-not-fix-it` (-, Aliens: Fireteam Elite 153076425, gap 253). game-design.game-feel.controls - `.the-menus-ignore-the-d-pad` (-, Remnant II 154242725), `.one-button-does-too-many-things` (-, Remnant II 203833778), `.one-input-device-is-the-better-way` (~, Warframe 9210860). `engineering.performance.gets-slower-the-longer-you-play` (-, Remnant II 203279608). game-design.difficulty-tuning - `.the-top-setting-is-locked-at-the-start` (-, Remnant II 213370670), `.swings-wildly-within-a-run` (-, Risk of Rain 2 98585564). `accessibility.memory-and-attention.too-much-at-once-for-some-players` (-, Risk of Rain 2 195505040). engineering.access - `.dies-when-the-servers-go` (-, Redfall 137851128, closes gap 53), `.offline-mode-only-if-you-already-had-it` (-, Redfall 227168510, gap 79).
- **Same-round re-homes found by findphrase:** Space Marine 2 175493177 (some menus take the d-pad, some need the sticks) off `ui-ux.hard-to-navigate`; Immortal Unchained 44648904 (better with mouse and keyboard than controller) off `controls.unknown`; Helldivers 2 177614140 ("a looming expiry when the servers shut down") off `live-ops.abandonment.unknown`.
- **Existing modes fit (3):** Aliens: Fireteam Elite 102370596 (a 1990s lobby where a community formed, gap 208) moved to `no-shared-place-between-runs`. Warframe 14582960 ("one player difficult ... four too easy") moved to `co-op-design.more-players-makes-it-trivial`, which already said this; round 392's note missed it. Space Marine 2 234734147 (a modifier cuts damage by 70%) stays on `random-rule-changes-frustrating`.
- **Skipped (1):** Remnant II 184993894 - the "first game had X" tally is open with Rico.

## Notes - round 402 (single-sighting backlog 6)

Backlog rows 101-120 read. Tree 1,183 -> 1,196 (13 modes). 19 bullets re-homed; 19 summary files across 7 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 352. The session restarted before this round; the hourly backstop found no 20-minute timer and re-created it, as the loop how-to says.

- **Built (13):** engineering.access - `.hard-to-delete-your-account` (-, Terminull Brigade 201488695, gap 126), `.had-to-find-the-fix-yourself` (-, 202735640, gap 147), `.no-lan-play` (-, Risk of Rain 2 55005796), `.the-extra-account-is-painless` (+, Warframe 6074990). engineering.bugs - `.a-skill-stops-working` (-, Risk of Rain 2 77622000), `.the-objective-spawns-inside-the-scenery` (-, Risk of Rain 2 212816305). engineering.matchmaking - `.the-queue-restarts-when-someone-leaves-it` (-, Aliens: Fireteam Elite 165382662, gap 260), `.sorting-by-conduct-made-it-bland` (-, ARC Raiders 209074506 and 220782723, gap 330), `.you-host-and-hope-someone-joins` (-, Space Marine 2 174830168), `.no-skill-matching-is-a-relief` (+, Space Marine 2 175777899), `.no-way-out-of-a-joined-game` (-, Remnant II 220763473), `.clumsy-to-use` (-, Risk of Rain 2 149731343), `.fills-your-game-with-players-automatically` (+, Warframe 10386859).
- **Existing modes fit (6):** Aliens: Fireteam Elite 128114816 ("quicker to uninstall and redownload than to patch", gap 233) to `live-ops.update-cadence.updating-eats-the-play-session`; 113401872 (an hour's wait for a teammate used up the refund window, gap 221) to `storefront.the-refund-clock-counts-time-i-was-not-playing`; 231704931 (queue for the mission you just finished to be carried forward, gap 307) to `community.player-conduct.players-teach-each-other-the-fix`; Space Marine 2 174564158 ("co-op matchmaking only works sometimes") to `matchmaking.cannot-find-games`; Warframe 14700535 (the Steam build does not run, the studio's own does, round 392) to `engineering.platform-support.better-elsewhere`, the reading round 392 asked for on a second sighting.
- **Stays (1):** Warframe 14266703 stays on `will-not-start-at-all`: its launcher also freezes (round 392).
- findphrase found no second sighting for the new modes; "LAN night" praise (Remnant II 201175078, Warframe 15628310) is about drop-in play and co-op, not a missing LAN mode.

## Notes - round 403 (single-sighting backlog 7)

Backlog rows 121-140 read. Tree 1,196 -> 1,208 (12 modes). 18 bullets re-homed; 18 summary files across 9 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 332. Run by the hourly backstop: the 20-minute timer was gone again after the session went idle.

- **Built (12):** engineering.netcode - `.idling-disconnects-you` (-, Aliens: Fireteam Elite 98962466, gap 188), `.the-risk-of-a-drop-makes-you-play-safe` (-, 130342858, closes gap 238). engineering.performance - `.my-friends-cannot-run-it` (-, Redfall 138589356, closes gap 59), `.locked-to-a-low-frame-rate` (-, ARC Raiders 234192662), `.compiles-shaders-every-launch` (-, Space Marine 2 179588130), `.slows-as-the-save-grows` (-, Remnant II 206126223), `.poorly-optimised` (-, Risk of Rain 2 81298531, the twin of `well-optimised`), `.needs-a-lot-of-memory` (-, Risk of Rain 2 112262688). `engineering.platform-support.asks-for-another-platform` (-, Aliens: Fireteam Elite 185663355 VR, Risk of Rain 2 124746293 Mac). engineering.servers - `.the-studio-limits-who-can-host` (-, The Anacrusis 154988428, closes gap 111), `.the-leaders-region-is-forced-on-everyone` (-, Terminull Brigade 202932618, closes gap 150), `.go-down-now-and-then` (-, Aliens: Fireteam Elite 202210130, gap 286).
- **Same-round re-home found by findphrase:** Warframe 9903914 ("wish it were on Mac; make a Mac version") off `not-supported-at-all`, whose definition needs the player to run it another way.
- **Existing modes fit (5 moved, 3 stay):** 116653275 ("what loading screens?") to `performance.quick-to-get-in`; 148758757 ("awesome, but their computer says otherwise") to `demanding-hardware`; 182197235 (PC made the same as console, "it sucks") to `platform-support.built-for-another-platform`; Aliens: Fireteam Elite 129788115 (peer to peer with no ping display, gap 240) to `matchmaking.no-ping-shown-before-you-join`. ARC Raiders 217296549 stays on `a-disconnect-loses-the-run` (reconnects downed and loses everything); Space Marine 2 175495463 (PS5 controller) stays on `broken-on-my-platform`; Risk of Rain 2 174481498 ("cannot play multiplayer") stays on `netcode.unknown` - no cause given.
- Risk of Rain 2 191032983 ("optimisation not great, poor frame rates on recent PCs") stays on `demanding-hardware`: it names the hardware.

## Notes - round 404 (single-sighting backlog 8)

Backlog rows 141-160 read. Tree 1,208 -> 1,218 (10 modes). 13 bullets re-homed, 1 split; 14 summary files across 8 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 312. Run by the hourly backstop; the 20-minute timer was gone again and was re-created.

- **Built (10):** engineering.servers - `.got-worse-over-time` (-, Aliens: Fireteam Elite 216577834 and 217256403, gap 286), `.poor` (-, the bare negative, Terminull Brigade 202047798 and Space Marine 2 175208608 found by findphrase), `.my-router-blocks-play` (-, Warframe 12018395). `review.cannot-tell-the-game-from-their-own-machine` (Immortal Unchained 44670314, closes gap 313; the line is split and the crashes stay on `crashes-repeatedly`). `game-design.ai-teammates.better-without-bots-at-all` (-, Aliens: Fireteam Elite 228598427, gap 303). game-design.co-op-design - `.a-bigger-team-would-absorb-a-drop` (-, 152599580, gap 255), `.teammates-take-your-kills` (-, Space Marine 2 216644931), `.you-miss-what-a-teammate-hears` (-, Remnant II 197321005), `.the-loot-does-not-grow-with-the-group` (-, Risk of Rain 2 59454004). `community.crossplay-and-platform-mix.friends-must-match-on-every-launcher` (-, Remnant II 187410273).
- **Existing modes fit (2 moved, 2 stay):** Remnant II 232251822 ("dialogue reads like ChatGPT before ChatGPT existed") to `production.craftsmanship.reads-as-machine-made`, which covers dialogue; The Anacrusis 116986915 (likes the low population because he gets the bots more, gap 87) to `community.playing-with-friends.the-bots-are-better-company-than-the-strangers`. 127988146 (unlocks deleted in a back-end migration, gap 94) stays on `progress-not-saved`; 130342858 (his slot goes to the useless bot, gap 239) stays on `ai-teammates.useless-in-combat`.
- **Skipped (6):** three friendly-fire rows (Space Marine 2 220778360, Remnant II 201175078, Helldivers 2 166414101) wait on the friendly-fire merge; three "first game had X" rows (Risk of Rain 2 59456532, Remnant II 150196497 and 184308304) wait on that tally. Both are in `OPEN-WITH-RICO.md`.

## Notes - round 405 (single-sighting backlog 9)

Backlog rows 161-180 read. Tree 1,218 -> 1,228 (10 modes). 18 bullets re-homed; 18 summary files across 6 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 292. Run by the hourly backstop; the 20-minute timer was gone again and was re-created.

- **Built (10):** game-design.co-op-design - `.the-player-cap-can-be-lifted` (~, Risk of Rain 2 94768725: four, or sixteen by console command), `.the-scaling-outpaces-a-full-group` (-, Risk of Rain 2 112262688, the inverse of `more-players-makes-it-trivial`), `.the-host-draws-the-enemies` (-, Helldivers 2 233555511, gap 37). `community.player-conduct.weaker-teammates-resent-your-power` (-, Risk of Rain 2 166897289). game-design.difficulty-tuning - `.harder-adds-new-rules` (+, Aliens: Fireteam Elite 197325200, gap 281, the twin of `harder-only-changes-the-numbers`), `.no-difficulty-settings` (-, Immortal Unchained 47911505, gap 314). game-design.enemy-design - `.the-wrong-enemy-for-the-pitch` (-, Aliens: Fireteam Elite 107005851, closes gap 218), `.one-enemy-type-is-hated` (-, Space Marine 2 174830168, Risk of Rain 2 95289745 and 105432534), `.hitscan-enemies-never-miss` (-, Risk of Rain 2 50411032 and 50152475, off `no-counterplay`), `.tells-how-they-died` (~, Risk of Rain 2 96263901 and 96262981).
- **Same-round re-home found by findphrase:** Aliens: Fireteam Elite 234088093 (a joke about being killed by a Burster) off `review.positive.unknown` onto `.tells-how-they-died`. Aliens: Fireteam Elite 98960267 ("lunging aliens have aimbot") stays on `no-counterplay`: a pounce, not a shot.
- **Existing modes fit (3 moved, 3 stay):** The Anacrusis 130919259 (the AI "feels livelier on Intense", gap 97) off `well-graded` to `the-lower-settings-are-not-worth-playing`; Immortal Unchained 49383116 (a cheat trainer, gap 316) to `review.used-a-cheat-to-get-through-it`; Risk of Rain 2 102411438 ("try not to get one-shot by an elite golem") to `one-hit-kills`. 155505786 stays on `harder-only-changes-the-numbers`; 164857357 stays on `poor-ai-behaviour`; 98585564 stays on `one-hit-kills`.

## Notes - round 406 (single-sighting backlog 10)

Backlog rows 181-200 read. Tree 1,228 -> 1,236 (8 modes). 20 bullets re-homed; 20 summary files across 4 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 272. Run by the hourly backstop; the 20-minute timer was re-created again.

- **The Risk of Rain 2 hated-enemy tally is closed onto `enemy-design.one-enemy-type-is-hated`** (built round 405): ten more bullets - 152614012, 154251555, 156066568, 56078147, 165436711, 187415210 (blind pests, wisps, jellies, void bugs), 178129320 (the final boss), 189635702 (the giant dino), 192251934 (Elder Lemurians), 235165802 (a wisp). The definition now says "enemy type or boss". Blind pests are the most-named enemy in it.
- **Built (8):** game-design.enemy-design - `.gimmick-enemies-ruin-a-run` (-, Risk of Rain 2 124296216), `.attacks-are-poorly-telegraphed` (-, 233552972). `game-design.game-feel.camera.third-person-lets-you-see-around-corners` (-, ARC Raiders 208435290 and 208759129, closes gap 326). game-design.game-feel.combat - `.attacks-go-where-you-move-not-where-you-face` (-, Space Marine 2 174828489, closes gap 350), `.too-much-slow-motion` (-, 206151338), `.the-defence-crowds-out-the-shooting` (-, 208087833 and 216646575; round 312 had said build on a fourth). `game-design.progression.unlock-pace.feels-powerful-early` (+, Risk of Rain 2 63127033, the inverse of `slow-start`). `game-design.game-feel.controls.too-many-buttons-to-manage` (-, Helldivers 2 219080218, closes gap 32).
- findphrase found no further sightings for the new modes.

## Notes - round 407 (single-sighting backlog 11)

Backlog rows 201-220 read. Tree 1,236 -> 1,247 (11 modes). 20 bullets re-homed; 20 summary files across 10 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 252. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (11):** `game-design.game-feel.controls.aim-response-is-inconsistent` (-, Rogue Core 231013391 and four Full Metal Schoolgirl reviews 207491180, 207697616, 207659048, 207516945 whose sensitivity doubles near traps; closes gaps 50 and 321 - those four were on `actions-trigger-by-themselves`, which is about actions, not aim). `game-design.game-feel.movement.no-player-collision` (-, Space Marine 2 175208610). `game-design.level-design.getting-lost-is-part-of-it` (~, Immortal Unchained 44738719, closes gap 312). game-design.modes - `.the-pvp-is-what-keeps-it-alive` (+, ARC Raiders 224997452), `.a-mode-is-locked-behind-gear` (-, Warframe 776593). `game-design.new-player-experience.returning-players-sent-back-through-the-tutorial` (-, Terminull Brigade 220429356, closes gap 168). game-design.ui-ux - `.no-place-to-test-a-build` (-, Aliens: Fireteam Elite 178096982, closes gap 267), `.a-place-to-test-your-build` (+, Remnant II 214769098, found by findphrase, off `quality-of-life-is-looked-after`). game-design.pacing - `.asks-for-no-thought` (-, Aliens: Fireteam Elite 186784591, closes gap 273), `.the-pressure-never-builds` (-, Space Marine 2 187921153), `.slow-to-get-going` (-, Risk of Rain 2 127659493).
- **Existing modes fit (5 moved, 4 stay):** 114289002 (sensitivity capped at 2.5, acceleration on) to `aim-sensitivity-cannot-be-tuned`; Space Marine 2 175776479 (use the class challenges to learn the jump packs) to `community.player-conduct.the-review-teaches-you-how-to-play`; ARC Raiders 230570266 (PvP "a bit bland because it is third person") to `modes.a-mode-falls-flat`; Space Marine 2 182849223 (long stretches of listening with no agency) to `pacing.the-level-pads-itself-with-lifts-and-walks`; Risk of Rain 2 161918313 (the late run turns into a bullet-hell simulator, praised) to `pacing.the-clock-is-the-thrill`. Staying: Remnant II 228597696 on `expected-mode-missing` (no new game plus); Redfall 221882982 on `easy-to-start`; Rogue Core 226874438 on `some-options-are-useless`.
- **Skipped (1):** Remnant II 144865141 (Survival mode dropped) - the "first game had X" tally is open with Rico.

## Notes - round 408 (single-sighting backlog 12)

Backlog rows 221-240 read. Tree 1,247 -> 1,262 (15 modes). 25 bullets re-homed, 1 split; 25 summary files across 7 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 232. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (15):** game-design.power-balance - `.no-build-is-required` (+, Aliens: Fireteam Elite 135224394, closes gap 244), `.every-option-plays-differently` (+, Space Marine 2 199241571), `.rarity-does-not-match-usefulness` (-, Risk of Rain 2 98585564), `.something-needs-a-nerf` (-, Risk of Rain 2 133828531 and 230565118 "nerf Solus Wing", plus 62761213 "nerf the Chronobauble" found by findphrase), `.power-creep` (-, Warframe 10487208), `.gear-decides-the-pve-fight` (-, Warframe 15627119, the PvE twin round 393 asked for). game-design.progression.build-and-customisation - `.finding-the-build-yourself-is-the-fun` (+, Aliens: Fireteam Elite 223260202, closes gap 298, with Risk of Rain 2 55619107 "do not go to YouTube for guides or tier lists" from round 347's note), `.upgrading-can-ruin-the-item` (-, Terminull Brigade 202168202, closes gap 131), `.other-classes-unlock-your-build` (~, 111224943, closes gap 219), `.pick-your-pronouns` (+, 130938542, closes gap 241), `.no-crafting-is-a-relief` (+, 134657679 split from its progression praise, plus Redfall 153047669 off `quality-of-life-is-looked-after`). `game-design.progression.achievements.easy-to-miss` (-, Redfall 217220281, gap 76, plus Redfall 158781459 and 204065207 off `gated-behind-unreachable-content`). `game-design.progression.cosmetic-rewards.you-cannot-see-them-while-playing` (-, Terminull Brigade 213157491 and Aliens: Fireteam Elite 109676560, closes gaps 163 and 220). game-design.progression.unlock-pace - `.no-credit-for-the-earlier-game` (-, Rogue Core 227463157, gap 48), `.needs-a-team-to-level-and-levels-to-find-a-team` (-, Aliens: Fireteam Elite 142139507, closes gap 246).
- **Existing modes fit (2 moved, 1 stays):** 195447402 (achievements by replaying a level) to `achievements.only-repetition-completes-the-set`; 98587457 ("needs more cosmetics") to `cosmetic-rewards.too-few-to-choose-from`, with Rogue Core 228635965 found by findphrase off `content-amount.too-little`. Terminull Brigade 201523627 (no stamina meter) stays on `respects-your-time`.
- Risk of Rain 2 229893369 ("the DLC characters have such a power creep") stays where it is: it is about paid characters. Redfall 213416396 ("a looter with no reason to loot because there is no crafting") stays on its minus mode - the same fact as `no-crafting-is-a-relief`, felt the other way.

## Notes - round 409 (single-sighting backlog 13)

Backlog rows 241-260 read. Tree 1,262 -> 1,278 (16 modes). 22 bullets re-homed; 21 summary files across 11 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 212. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (16):** game-design.progression.unlock-pace - `.finishing-pays-nothing` (-, Aliens: Fireteam Elite 215331196 and 215328210, closes gap 291), `.rank-decays-if-you-stop-playing` (-, ARC Raiders 217819162, closes gap 339), `.each-mode-levels-separately` (-, Space Marine 2 174564873, closes gap 346), `.levelling-up-feels-like-nothing` (-, Space Marine 2 174564000, Remnant II 143613520, Warframe 9690006), `.pays-for-finishing-not-for-playing` (-, Space Marine 2 182849223), `.the-classes-should-all-be-open-from-the-start` (-, Remnant II 145364531), `.little-reason-to-keep-going` (-, Risk of Rain 2 55007934), `.an-unlock-challenge-is-a-chore` (-, Risk of Rain 2 63510134, the three-combat-shrines unlock; its "lunar coins are annoying" line stays on `unlock-pace.unknown`), `.the-endgame-is-only-more-unlocks` (-, Risk of Rain 2 118417284), `.some-gear-needs-a-clan` (~, Warframe 6920334), `.the-game-sets-no-goals` (-, Warframe 19719634, round 396's note). `game-design.punishment-model.one-mistake-locks-content-away` (-, Immortal Unchained 59499649, closes gap 317). game-design.readability - `.guidance-feels-patronising` (-, The Anacrusis 130889109, closes gap 98), `.the-numbers-grow-too-big-to-mean-anything` (-, Terminull Brigade 202364661, closes gap 143). `game-design.role-design.classes-exist-to-stretch-the-grind` (-, Aliens: Fireteam Elite 156056667, closes gap 257). `game-design.solo-viability.solo-play-keeps-the-multiplayer-rules` (-, Aliens: Fireteam Elite 195921196, both its lines, closes gap 275).
- **Existing modes fit (2 moved, 2 stay):** Redfall 138688226 ("death means nothing", gap 65) to `punishment-model.dying-costs-nothing`, built after gap 65 was written; ARC Runner 138076943 (unlocks make the first areas trivial, gap 320) to `pacing.the-early-stages-of-every-run-are-dull`. ARC Runner 138105024 stays on `padding-a-short-game` ("shoehorned in to stall progress"); Aliens: Fireteam Elite 226851558 ("almost punishes him for playing solo") stays on `punishing-solo`.

## Notes - round 410 (single-sighting backlog 14)

Backlog rows 261-280 read. Tree 1,278 -> 1,291 (13 modes). 23 bullets re-homed; 23 summary files across 9 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 192. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (13):** `game-design.ai-teammates.bots-cost-currency-every-run` (-, Voidcrisis 120026161, closes gap 322). game-design.ui-ux - `.prompts-show-the-wrong-button` (-, Rogue Core 226248403 and Aliens: Fireteam Elite 105420602, closes gaps 41 and 210), `.a-default-setting-is-not-what-the-studio-says` (-, The Anacrusis 130364645, closes gap 100), `.menus-are-slow-web-pages` (-, Terminull Brigade 204200343, closes gap 151), `.starts-on-the-highest-settings` (-, 204349358, closes gap 152), `.forgets-your-settings-between-launches` (-, Aliens: Fireteam Elite 99792547, closes gap 192, plus Redfall 178634443 found by findphrase off `bugs.buggy`), `.several-loadouts-can-be-saved` (+, 192190824, the twin of `no-way-to-save-a-loadout`), `.fast-travel-comes-late-and-costs` (-, Immortal Unchained 44643684, 115056932, 119730016, closes gap 318, plus 115517229 found by findphrase), `.lets-you-waste-a-consumable` (-, Remnant II 154242443), `.the-map-has-no-compass` (-, Remnant II 234695004), `.no-confirmation-before-a-costly-action` (-, Risk of Rain 2 50152404). `review.takes-back-an-earlier-complaint` (Aliens: Fireteam Elite 102406273, closes gap 205; it had been on `hides-information`). `game-design.co-op-design.the-map-is-not-shared` (-, Remnant II 222197668).
- **Existing modes fit (6 moved, 3 stay):** Voidcrisis 149271537 (hire the bots, the currency resets) to `the-review-teaches-you-how-to-play`; Terminull Brigade 216458142 to `managing-the-inventory-is-a-chore`; Aliens: Fireteam Elite 113401872 (hit points counted at 1,500 give no sense of fragility, gap 224) to `readability.the-numbers-grow-too-big-to-mean-anything`, whose definition now names health; 222184315 (cannot test a gun before buying, gap 293) to `no-place-to-test-a-build`; Remnant II 168624915 (no HUD adjustment on an ultrawide) to `does-not-support-my-screen-shape`. Staying: Voidcrisis 120026122 on `punishing-solo`; Rogue Core 226894965 on `missing-quality-of-life`; Risk of Rain 2 114747985 on `grind-feels-earned`.
- Immortal Unchained 135479892 and 155414538 name the late fast travel alongside other faults and stay on their modes; 169563263 (pays for fast travel and to unlock levels) stays on `grindy`.

## Notes - round 411 (single-sighting backlog 15)

Backlog rows 281-300 read. Tree 1,291 -> 1,304 (13 modes). 17 bullets re-homed; 17 summary files across 8 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 172. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (13):** `game-design.progression.unlock-pace.the-grind-crowds-out-the-game` (-, Warframe 15627119, round 393's note; its other grind line stays on `grindy`). `game-design.level-design.the-boss-arena-can-roll-badly` (-, Risk of Rain 2 49884651). live-ops.patch-quality - `.fixes-what-suits-the-studio-first` (-, Helldivers 2 206818861, closes gap 31), `.removes-what-players-worked-out` (-, 223944412, closes gap 35), `.the-planned-content-is-only-cosmetics` (-, Aliens: Fireteam Elite 98588270 and 113090707, closes gap 187), `.a-fix-was-rolled-back` (-, 99805384, closes gap 193), `.the-fix-came-too-late` (-, 100698702, closes gap 202), `.an-update-reads-as-a-rescue-attempt` (-, 117010451, closes gap 229), `.each-update-is-a-content-island` (-, Warframe 17323915, round 394's note). live-ops.abandonment - `.a-system-was-left-half-finished` (-, Helldivers 2 223944615, closes gap 34), `.its-failure-cancelled-other-games` (-, Redfall 220458097's sequels line, closes gap 82). `community.developer-communication.what-a-cheater-took-was-given-back` (+, ARC Raiders 208760405, closes gap 328, the twin of `what-a-cheater-took-is-never-given-back`). `publishing.monetisation-practice.what-i-bought-was-weakened-later` (-, Helldivers 2 163948394, closes gap 15).
- **Existing modes fit (3 moved, 4 stay):** Risk of Rain 2 78908676 (25 hours without the Huntress skin) to `an-unlock-challenge-is-a-chore` (round 409); The Anacrusis 146072452 (Update 49 was to fix the audio and did not) to `the-notes-do-not-match-the-patch`; Terminull Brigade 202085509 (the season moved it from roguelike to gear-based) to `replaced-the-core-loop-with-a-different-one`. Staying: 139344421 on `keeps-pulling-you-back`; Remnant II 163946710 on `the-best-things-are-hidden-behind-a-guide`; Risk of Rain 2 82462032 on `removed-a-feature`; Rogue Core 226243069 ("too little too late") on `content-thin`.

## Notes - round 412 (single-sighting backlog 16)

Backlog rows 301-320 read. Tree 1,304 -> 1,317 (13 modes). 19 bullets re-homed; 19 summary files across 9 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 152. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (13):** live-ops.update-cadence - `.one-region-gets-content-first` (-, ARC Raiders 228603070, closes gap 344), `.promised-content-keeps-slipping` (-, Risk of Rain 2 149731343), `.slow-but-worth-the-wait` (+, Warframe 12192077). `live-ops.patch-quality.new-items-thin-out-the-pool` (-, Risk of Rain 2 102412062, round 359's note). marketing.discovery - `.a-reward-campaign-farms-installs` (-, Terminull Brigade 214146426, closes gap 165), `.sat-unplayed-before-it-clicked` (+, Aliens: Fireteam Elite 183502378 and 194929249, closes gap 270, plus Risk of Rain 2 185677801 "slept on this game and wholly regret it" off `review.positive.unknown`), `.bought-it-ahead-of-the-sequel` (~, 232857207, closes gap 306), `.launched-in-the-shadow-of-a-bigger-game` (-, Remnant II 174461518), `.came-from-a-rival-that-failed-them` (~, Risk of Rain 2 188450586, left ARK), `.found-it-in-the-store` (~, Warframe 18049800, the Steam queue). `marketing.expectation-management.sold-as-finished-and-unfinished-at-once` (-, Rogue Core 231767228, closes gap 51). marketing.positioning - `.does-not-know-what-it-is` (-, Remnant II 222191203, plus Redfall 138294159 and 158050571 off `wasted-its-potential`, whose lines say the same words), `.a-game-not-a-service` (+, Risk of Rain 2 55619107, round 347's note).
- **Existing modes fit (2 moved, 4 stay):** The Anacrusis 134169266 (the game came free from a developer, gap 101) to `review.discloses-a-free-copy-from-the-studio`; Terminull Brigade 201754661 (arriving by a reward quest did not make his review dishonest, gap 132) to `review.answers-a-claim-made-in-another-review`. Staying: ARC Raiders 232304517 on `too-slow` ("feels abandoned"); Redfall 137836468 and 137851053 on `came-free-with-hardware` (the lines say only that); The Anacrusis 113518559 on `claim-was-untrue`.
- **Skipped (1):** Risk of Rain 2 139711203 (prefers the first game) - the "first game had X" tally is open with Rico.
- The rendered tree page now counts 108 subjects with observations, not 109: `marketing.unknown` held one bullet (214146426), which this round moved.

## Notes - round 413 (single-sighting backlog 17)

Backlog rows 321-340 read. Tree 1,317 -> 1,332 (15 modes). 17 bullets re-homed; 17 summary files across 7 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 132. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (15):** marketing.reputation - `.also-recommends-another-game` (~, Helldivers 2 165434184, closes gap 22), `.good-material-for-a-video` (+, 186862399, closes gap 30), `.wants-this-formula-in-another-licence` (+, Aliens: Fireteam Elite 118861323, closes gap 228), `.traces-the-studios-lineage` (~, 179031332, closes gap 268), `.still-holds-up-years-later` (+, 223164866, closes gap 300), `.streamers-play-a-different-game` (-, ARC Raiders 209075085, closes gap 329), `.suspects-the-early-ratings` (-, Space Marine 2 175775436), `.a-rebuke-to-the-rest-of-the-industry` (+, 182853251 and 182853784, off `old-fashioned-and-better-for-it`; round 305 said split on a third, and Rule C builds now), `.likes-the-people-running-the-studio` (+, 183511748, the twin of `studio-politics-put-me-off`), `.worse-now-than-at-launch` (-, 194969567, the inverse of `recovered-over-time`). `review.written-to-pull-the-score-back` (Terminull Brigade 229142544, closes gap 182). `publishing.monetisation-practice.sells-with-restraint` (+, Space Marine 2 185057274). narrative.characters-writing - `.in-jokes-replace-the-writing` (-, The Anacrusis 117387804, closes gap 90), `.the-best-lines-rarely-play` (-, 166892773, closes gap 114), `.your-own-character-is-nobody` (-, Aliens: Fireteam Elite 142633262, closes gap 251).
- **Existing modes fit (1 moved, 4 stay):** Risk of Rain 2 155515469 (gifted it to two friends to play with them) to `marketing.discovery.i-bought-it-for-other-people`. Staying: Helldivers 2 225615617 on `judged-unfairly` (the abandoned engine is the cause); Risk of Rain 2 111773633 on `praise-is-undeserved` ("overrated - the top negative reviews nail why"); 79326857 on `memorable-specials`; The Anacrusis 117387804's "lifeless survivors" line on `flat-or-annoying`.

## Notes - round 414 (single-sighting backlog 18)

Backlog rows 341-360 read. Tree 1,332 -> 1,347 (15 modes). 17 bullets re-homed; 16 summary files across 7 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 112. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (15):** narrative.story - `.the-full-story-is-in-a-tie-in-book` (~, Aliens: Fireteam Elite 101975553, closes gap 204), `.makes-sense-only-if-you-know-the-source` (-, 169885487, closes gap 263), `.the-last-games-hero-is-left-out` (-, Remnant II 143171238, round 318's note), `.the-play-and-the-story-do-not-match` (-, 201612330, round 339's note), `.spoils-the-earlier-game` (-, 209860050, round 340's note), `.earlier-choices-do-not-carry-over` (-, 217281349, round 341's note), `.kept-cryptic-on-purpose` (~, Warframe 17323915, round 394's note), `.a-twist-took-away-the-fantasy` (-, Warframe 12111253, round 390's note; it had been on `breaks-its-own-fiction`). `narrative.tone.cosmetics-break-the-tone` (-, Aliens: Fireteam Elite 125456106, closes gap 234). narrative.world-and-setting - `.the-world-is-never-explained` (-, The Anacrusis 140195700 and Aliens: Fireteam Elite 125456106, closes gaps 106 and 236), `.adds-to-the-source-without-harming-it` (+, 121546450, closes gap 231), `.works-for-people-new-to-the-source` (+, 223260202, closes gap 297), `.the-faithful-version-must-be-unlocked` (-, 229212351, closes gap 305), `.what-you-do-never-changes-the-world` (-, ARC Raiders 220132764, closes gap 341). `game-design.ui-ux.an-option-exists-and-is-hard-to-find` (-, Space Marine 2 177612801, round 301's note).
- **Existing modes fit (1 moved, 2 stay):** Immortal Unchained 48489315 (redeem or doom an NPC by how you play, gap 315) to `narrative.story.your-choices-change-the-story`. Staying: Redfall 212739989 ("hollow set pieces", gap 61) on `setting-feels-thin`, since the line also says the map is devoid of life; Terminull Brigade 201168965 (environmental storytelling, gap 123) on `world-worth-exploring`, where findphrase shows six other environmental-storytelling lines already sit.
- **Skipped (1):** Remnant II 151192360 (missed the desert biome) - the "first game had X" tally is open with Rico. Remnant II 143171238 and 217281349 (the hero dropped, the choices lost) would count toward that tally too if Rico makes one; they are built here as story modes only.

## Notes - round 415 (single-sighting backlog 19)

Backlog rows 361-380 read. Tree 1,347 -> 1,359 (12 modes). 19 bullets re-homed and 1 split; 20 summary files across 8 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 92. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (12):** game-design.new-player-experience - `.guides-you-without-holding-your-hand` (+, Remnant II 149259423, round 326's note), `.learn-it-alone-before-joining-others` (~, Risk of Rain 2 68329495, round 351's note). community.social-features - `.nothing-shows-others-what-you-earned` (-, Warframe 10209689, round 388's note; its bullet was split, since the review names two things: the "not much more to do" half stays on `nothing-left-to-chase`, and the recognition half is a new bullet), `.the-studio-chat-helps-you-find-a-team` (+, Risk of Rain 2 68329334, round 351's note, the twin of `only-the-studio-chat-fills-a-lobby`). `game-design.power-balance.a-weapon-fails-at-its-own-job` (-, Helldivers 2 165939159, closes gap 26). production.content-amount - `.worried-it-will-run-dry` (-, Risk of Rain 2 51104580, round 346's note), `.wants-more-because-it-is-good` (+, 128128319 and 145882843, rounds 364 and 367). production.content-variety - `.side-content-is-empty-errands` (-, Redfall 218919304, closes gap 78), `.repetition-comes-with-the-genre` (~, Aliens: Fireteam Elite 102381886, closes gap 207), `.repetitive-and-still-fun` (~, 184877306 and 130936199, closes gap 271), `.the-randomisation-is-only-surface` (-, 109676560, closes gap 215), `.wants-more-than-shooting` (-, 206046626, closes gap 287).
- **Existing modes fit (6 moved, 1 row stays):** Risk of Rain 2 222210554 and 226907406 (confusing without a wiki or videos) to `complexity.requires-outside-research`, which is the "guide half" rounds 380 and 381 thought had no mode; 95808502 ("fun but short") to `content-amount.too-little`, where "the game is relatively short" already sits; Terminull Brigade 221339205 (generated levels in place of designed ones, gap 170) to `the-generation-adds-nothing`; 217842597 (the guns are not meaningfully different, gap 173) to `power-balance.options-feel-identical`; Rogue Core 226821176 (hundreds of typos, gap 46) to `craftsmanship.the-writing-was-never-edited`, built after gap 46 was written. Staying: Risk of Rain 2 65664477 (wants progress to matter between games) on `nothing-accumulates`, which is the same fact.
- Gap 271's other two lines stay on `repetitive`: Aliens: Fireteam Elite 165385875 ("somewhat repetitive ... no frills") does not say it is forgiven, and 113919244 wishes it were not so repetitive.

## Notes - round 416 (single-sighting backlog 20)

Backlog rows 381-400 read. Tree 1,359 -> 1,376 (17 modes). 22 bullets re-homed; 22 summary files across 7 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 72. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (17):** production.craftsmanship - `.barely-playtested` (-, Redfall 138168807, gap 57), `.a-parody-of-a-big-budget-game` (-, 138543902, gap 57; gap 57 had wondered about `beaten-by-a-competitor`, but neither line names or points to another game), `.placeholder-text-left-in` (-, Terminull Brigade 216426353, closes gap 167), `.only-the-licence-holds-it-up` (-, Aliens: Fireteam Elite 213261548, closes gap 288). production.early-access - `.hopes-the-updates-prove-this-wrong` (~, Risk of Rain 2 59456532, round 348's note; the line names no fault, so it is neutral), `.still-called-unfinished-years-later` (-, Warframe 7718099, round 386's note). `production.launch-state.the-team-was-too-small` (-, Redfall 220458097's headcount line, closes gap 81; its "launched broken" line stays on `shipped-broken`). `game-design.level-design.buildings-you-cannot-enter` (-, Redfall 138162943 and 138552886, closes gap 61). `production.scope-mismatch.reads-as-a-changed-plan` (~, Aliens: Fireteam Elite 112659646, closes gap 222). `game-design.progression.complexity.the-learning-curve-is-well-paced` (+, Risk of Rain 2 168646742, round 371's note). publishing.availability - `.one-purchase-covers-two-platforms` (~, The Anacrusis 130606589, closes gap 96), `.the-shop-is-blocked-in-my-country` (~, Terminull Brigade 202849884, closes gap 142). publishing.data-and-privacy - `.worried-about-account-security` (-, Helldivers 2 165938143, closes gap 23), `.accused-of-mining-currency` (-, Terminull Brigade 213980448, 213157491, 223962180, closes gap 161), `.the-agreement-strips-buyer-rights` (-, 221339205, closes gap 172). publishing.dlc-and-editions - `.should-give-the-dlc-away-to-make-amends` (-, Aliens: Fireteam Elite 105423489, closes gap 214), `.the-add-on-lets-more-people-play` (~, 118861323, closes gap 225; the review mentions it in passing inside a positive review, so it is recorded as a fact, not as a paid fix).
- **Existing modes fit (2 moved, 2 stay):** Risk of Rain 2 125546058 (a review written as newbie advice) to `community.player-conduct.the-review-teaches-you-how-to-play`; 135838735 ("do not know what is happening, but like it") to `complexity.overwhelming-at-first`. Staying: Aliens: Fireteam Elite 137970466 (wants a relaunch like Rainbow Six Siege) on `the-potential-is-still-there`; Risk of Rain 2 55619107's "do not look up guides" line was already on `finding-the-build-yourself-is-the-fun`.
- Redfall 212739989 ("buildings are hollow set pieces") stays on `setting-feels-thin`, as round 414 decided; the new `buildings-you-cannot-enter` is about not being able to walk in.

## Notes - round 417 (single-sighting backlog 21)

Backlog rows 401-420 read. Tree 1,376 -> 1,387 (11 modes). 19 bullets re-homed and 2 reworded; 19 summary files across 5 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 52. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (11):** publishing.dlc-and-editions - `.a-paid-pack-is-worth-it-for-the-head-start` (+, Aliens: Fireteam Elite 221337041, closes gap 294), `.sold-as-old-style-add-ons` (+, Space Marine 2 185057274, round 306's note), `.got-only-part-of-the-add-on` (-, Remnant II 176116565, round 335's note), `.a-weaker-add-on-still-welcome` (~, Risk of Rain 2 200469362, round 377's note), `.pricey-but-worth-it` (~, 215438049, 223335550, 224998148, rounds 379 and 380). `game-design.new-player-experience.dropped-into-the-add-on-first` (-, Remnant II 206818675, round 340's note). `publishing.monetisation-practice.the-pass-does-not-pay-for-the-next` (-, Terminull Brigade 202390416, closes gap 144). publishing.ownership - `.the-owner-is-not-disclosed` (-, 213157491, closes gap 164), `.put-off-by-the-country-it-comes-from` (-, 220325602, closes gap 174), `.dislikes-the-owner` (-, Risk of Rain 2 129132146, 177125124, 177611446, rounds 364 and 373), `.the-new-owner-cares-less-than-the-makers` (-, 182854034, round 374's note).
- **Existing modes fit (4 moved, 1 stays):** Aliens: Fireteam Elite 202151006 ("just a vehicle for DLC", gap 283) to `monetisation-practice.feels-like-a-cash-grab`; Space Marine 2 228059310 (grind for the models or buy the DLC that holds them) to `paying-only-shortens-the-grind`; Risk of Rain 2 75245394 (rough patches from the Seekers DLC onwards) to `live-ops.patch-quality.made-it-worse`; 181184333 (the latest DLC does not fit the theme) to `narrative.world-and-setting.breaks-its-own-fiction`. Staying: 141559948 ("gearbox", one word) on `ownership.unknown` - it gives no verdict.
- **Reworded (2):** Risk of Rain 2 129132146 and 177611446 named the owner's head in a jab; both bullets now read "a jab at the owner's named head", and the same words were taken out of the backlog quote column and the round 364 and 373 notes above. The raw sample keeps the original text.
- Owner tally for the Gearbox era, as rounds 373-374 counted it, is unchanged by this round: these lines were counted as "raised" and are now `dislikes-the-owner` or `the-new-owner-cares-less-than-the-makers`.

## Notes - round 418 (single-sighting backlog 22)

Backlog rows 421-440 read. Tree 1,387 -> 1,400 (13 modes). 19 bullets re-homed; 19 summary files across 9 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 32. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (13):** publishing.price - `.the-discount-for-owning-the-last-game-is-too-small` (-, Rogue Core 226888173, closes gap 43), `.dropped-so-fast-launch-buyers-lost-out` (-, Redfall 150163099, closes gap 70), `.worked-out-as-price-per-hour` (~, Aliens: Fireteam Elite 173874895 and 196599011, closes gap 265; the arcade-quarters line is the second sighting gap 265 held open). publishing.sale-dependency - `.the-sale-came-after-the-players-left` (-, 229190054, closes gap 304), `.wait-for-the-fixes-before-buying` (-, Space Marine 2 176116366, round 299's note). `game-design.punishment-model.dying-makes-the-next-try-harder` (-, Remnant II 178581678, round 335's note). `publishing.refund.try-it-and-refund-if-not` (+, Risk of Rain 2 78037782, round 353's note). `game-design.replayability.interest-comes-and-goes-in-waves` (~, Warframe 14471201, round 392's note). review - `.explains-their-own-reviewing-rule` (The Anacrusis 138104106, closes gap 107), `.says-a-language-model-proofread-it` (Terminull Brigade 202010018, closes gap 136), `.judges-later-content-from-videos` (201988059, closes gap 137), `.kept-as-a-log-of-reward-campaigns` (213226072, closes gap 157), `.describes-a-different-game` (229578207, closes gap 181).
- **Existing modes fit (5 moved, 1 stays):** Risk of Rain 2 196660257 ("a greasy publisher owned by a scummy company") to `ownership.dislikes-the-owner`, built last round; 51241196 (the red item that turns out to be a Frost Relic) to `power-balance.rarity-does-not-match-usefulness`; Redfall 167599060 (asks fans to thumb it up so the executives see their mistake, gap 72) to `review.tells-other-reviewers-how-to-vote`; The Anacrusis 153020841 (rebuts another review's achievement claim, gap 109) to `review.answers-a-claim-made-in-another-review`; Aliens: Fireteam Elite 99415093 (full review on his site, links his channel, gap 190) to `review.promotes-the-reviewers-own-stream-channel`. Staying: Space Marine 2 175776374 on `repetitive` - it says "the same" four times, and the lift ride is one of the repeats, not padding on its own.

## Notes - round 419 (single-sighting backlog 23)

Backlog rows 441-460 read. Tree 1,400 -> 1,415 (15 modes). 18 bullets re-homed; 18 summary files across 5 games. dircheck 0; unfitted 0 in every game touched. Open rows left: 12. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (15):** review - `.checked-the-source-to-settle-a-claim` (Aliens: Fireteam Elite 120700957, closes gap 232), `.asks-readers-for-help` (125469181, closes gap 237), `.thumb-down-over-one-thing-in-a-game-they-love` (170576202, closes gap 264; it had been on `thumb-contradicts-text`, but the same review says why - three players is too few), `.points-to-a-video-to-make-the-case` (175061599, closes gap 266), `.apologises-for-their-own-writing` (195447402, closes gap 279), `.is-only-a-link` (214774513, closes gap 290), `.says-who-it-is-written-for` (228598427, closes gap 302), `.takes-a-side-in-a-dispute-between-players` (ARC Raiders 218339519 and 222774359, closes gap 338), `.posted-under-both-games-in-the-series` (Remnant II 223301401, round 342's note), `.reads-like-a-store-blurb` (217277338, round 341's note). `community.player-conduct.players-make-excuses-for-the-studio` (-, Aliens: Fireteam Elite 153050119, closes gap 254). `publishing.price.worth-the-money-but-not-the-time` (~, 179057030, closes gap 269). production.craftsmanship - `.refuses-a-game-made-with-generative-ai` (-, ARC Raiders 209801698, closes gap 334; it had been on `thumb-is-a-protest-vote`), `.so-bad-it-is-good` (+, Redfall 138654399, closes gap 67). `engineering.bugs.fixing-it-is-not-the-players-job` (-, Remnant II 203815579, round 339's note).
- **Existing modes fit (2 moved, 2 already right):** Aliens: Fireteam Elite 145398249 (the whole review in character as a distress call, gap 252) to `review.written-in-the-games-own-voice`, built after gap 252 was written; Risk of Rain 2 142162830 ("Commando sucks") to `role-design.role-underpowered`. Already right: Immortal Unchained 44984444's review-copy line was already on `discloses-a-free-copy-from-the-studio` (gap 309); Risk of Rain 2 56724222's "this will get buried" line was already on `says-few-people-will-read-it`.

## Notes - round 420 (single-sighting backlog 24 - the last open rows)

Backlog rows 461-472 read. Tree 1,415 -> 1,420 (5 modes). 7 bullets re-homed; 7 summary files across 3 games. dircheck 0; unfitted 0 in every game touched. **No `open` rows are left** (built 342, existing 114, skip 63, check 24). Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (5):** game-design.role-design - `.defends-a-character-others-call-weak` (+, Risk of Rain 2 235158351, round 382's note, the Commando defence), `.too-few-abilities-per-character` (-, 101996582, round 358's note). `community.user-created-content.an-update-broke-the-mods` (-, 50534342, round 345's note). game-design.world-interaction - `.the-interact-key-picks-the-wrong-thing` (-, Remnant II 143172124, round 317's note), `.wait-for-the-npc-before-you-can-talk` (-, 198583201, round 338's note).
- **Existing modes fit (2 moved, 1 stays):** Space Marine 2 228059310 (trying to be several genres at once) to `marketing.positioning.does-not-know-what-it-is`, built in round 412; Risk of Rain 2 73939867 ("the only problem is the servers") to `engineering.servers.poor`. Staying: Remnant II 232251822 (quiet, then enemies spawn behind you) on `enemy-design.unfair-spawns`, where "enemy placement can get infuriating" already sits.
- **Skipped (4):** Risk of Rain 2 55007934 and 54909270, Remnant II 150195079 and 217281349 - all four are the "first game had X" pattern, which is open with Rico.
- Commando tally unchanged: 2 complaints, 1 defence.

## Notes - round 421 (single-sighting backlog - the 24 check rows)

The 24 `check` rows read ("gap closed but bullet still on parked tag"). Tree 1,420 -> 1,424 (4 modes). 9 bullets re-homed, one of them a wrong tag found on the way; 8 summary files across 5 games. dircheck 0; unfitted 0 in every game touched. **The single-sighting backlog is finished:** built 347, existing 133, skip 63, nothing `open` or `check`. Run by the hourly backstop; the 20-minute timer was re-created again.

- **Built (4):** `game-design.enemy-design.one-enemy-is-overtuned` (-, Space Marine 2 174563824 and 175773867, the Chaos Spawns, rounds 290 and 297). `game-design.game-feel.combat.feels-bad-even-when-played-well` (-, 203836847, round 310's note). `game-design.progression.achievements.does-not-say-what-is-missing` (-, Aliens: Fireteam Elite 100234073, gap 194; it had been on `ui-ux.hides-information`). `community.culture.the-community-completes-the-game` (+, Helldivers 2 159572833, gap 13; it had been on `world-worth-exploring`).
- **Moved to existing modes (4):** Space Marine 2 175207340 ("the Chaos enemies are not fun to fight") to `one-enemy-type-is-hated`; Remnant II 146779750 ("lore-dumps a lot of information at once") to `narrative.story.the-game-talks-too-much`, whose definition names lore dumps; Warframe 13746977's colours line to `colours-and-basic-cosmetics-cost-real-money`.
- **Wrong tag fixed (1):** Warframe 13746977's "pay to make it quicker" line sat on `colours-and-basic-cosmetics-cost-real-money`; it now sits on `paying-only-shortens-the-grind`, which is what it says. Every other bullet on the colours mode was checked; the one other is right.
- **Already moved before this round (6):** The Anacrusis 117387804 and 140195700, Space Marine 2 174828489, Aliens: Fireteam Elite 195447402 and 98587457, Risk of Rain 2 55007934 - each parked line had been re-homed when its gap closed; only the status was stale.
- **Stay where they are (10):** the line left on the parked tag is a different claim from the one that closed the gap, and the parked tag fits it - Aliens: Fireteam Elite 98954260 (`atmosphere.falls-flat`), 108073875 (`cannot-communicate`); Helldivers 2 164954987 (`listens-and-acts`); The Anacrusis 146072452 and 108031523 (`listens-and-acts`); Terminull Brigade 202556859 (`written-to-the-studio-not-to-the-buyer`); Space Marine 2 176115434 (`slow-start`), 176593790 (`says-they-are-the-target-audience`); Redfall 139653665 (`updates-stopped`), 138538137 (`delivered-less-than-promised`); Remnant II 144296899 (`rock-solid`).

## Notes - round 422 (Warframe batch 15)

50 read (2016-02-29 to 2016-05-07), 111 bullets, 0 excluded, 10 edited later. Running total 750 of 3,235. 48 up / 2 down. 32 bullets on an `.unknown` (30 of them bare praise or bare complaint). Tree 1,424 -> 1,430 (6 modes, built on first sighting under Rule C). First Warframe batch since the stop on 2026-09-24; `GAMES-TODO.md` row 5 is back to WIP.

- **Built (6):** publishing.monetisation-practice - `.you-end-up-paying-sooner-or-later` (-, 22013309 "you WILL HAVE TO PAY FOR STUFF SOONER OR LATER"; 10209689 "it does cost money eventually, no matter what" moved to it off `.unknown`), `.advises-what-not-to-spend-on` (~, 21694803 "don't buy anything with platinum unless it's slots", 21859587 "I'll suggest you don't invest money"). `production.content-variety.more-to-do-than-fighting` (+, 21859587, the twin of round 415's `wants-more-than-shooting`). `engineering.platform-support.clumsy-on-a-phone` (-, 22013567: the phone version's cluttered screen and weak touch controls). `community.player-conduct.a-teammate-sets-off-a-trap-on-you` (-, 21861158: lasers on a defence mission). `marketing.discovery.tried-it-because-it-was-free` (~, 22292504: free and four-player, for a group of four).
- **A jab at a named player** (22168981 opens by calling another player toxic) is recorded as "a jab at a named player", name left out, on `player-conduct.unknown`.
- **Two reviews in other languages** under the English tag: 22012916 (Turkish) and 22853780 (Polish), each with a language line and a bare-praise line, as earlier batches did.
- **Three joke or junk reviews kept, not excluded:** 22291313 (a keyboard mash), 22439296 (one crude word), 22168043 (a crude joke). Each says nothing about the game and sits on `review.positive.unknown`; unlike the barnacle poem (21038519), none is a text about something else.
- **Multi-dated reviews flattened this batch:** 22013567 (2016 created, 2026 edit - the Steam Deck and phone lines are from the edit), 21694803 (2016, edited 2019), 22290897 (2016, edited 2024), 22439846 (2016, edited 2022), 22732707 (2016, edited 2026), 22168981 (2016, edited 2018), 22730574 (2016, edited 2017), 22730530 (2016, edited 2018), 21553738 (2016, edited 2016-09), 21859587 (edited a week later; its "adjustment" lines are marked as the later edit).

## Notes - round 423 (Warframe batch 16)

50 read (2016-05-15 to 2016-07-23), 176 bullets, 0 excluded, 16 edited later. Running total 800 of 3,235. 47 up / 3 down. 18 bullets on an `.unknown`. Tree 1,430 -> 1,441 (11 modes, built on first sighting under Rule C). First unit on the 10-minute cadence (Rico, 2026-09-25).

- **The batch's weight is one review:** 23161305 (thumbs down, 6,720 hours, 456 found it helpful, created 2016 and rewritten in a 2025 edit) gives 30 bullets - the downward spiral, the grind, host migrations that lose the rewards, time walls, low drop chances, no tutorial, the wiki, nerfs, bullet sponges that one-shot, invulnerable boss phases, the trade and recruit chat, overpriced platinum, and the story and tone going downhill since about 2023.
- **Built (11):** `controls.the-steam-overlay-shortcut-clashes` (-, 23160257). `narrative.story.the-story-got-worse-over-time` (-, 23161305). `enemy-design.bosses-hide-behind-invulnerable-phases` (-, 23161305). `social-features.recruiting-is-a-wall-of-chat` (-, 23161305; its trading half went on `the-player-market-works-badly`). `content-variety.every-reward-comes-from-the-same-missions` (-, 23160854, the Void). live-ops.patch-quality - `.fixes-come-within-hours` (+, 23160854), `.each-update-adds-more-grind` (-, 23161305). `review.written-as-a-diary-at-hour-marks` (23577928, entries at 30, 50 and 100 hours). `unlock-pace.the-endgame-is-within-reach` (+, 23318065). `platform-support.better-here-than-elsewhere` (+, 23441031, the inverse of `better-elsewhere`). `monetisation-practice.a-fair-business-model` (+, 23010711 and 23714521; 20160494 "the business model is really well put together" moved to it off `.unknown`).
- **Round 422's modes got second and third sightings:** `advises-what-not-to-spend-on` took four (23161305 buy platinum only with a 50% coupon, 23318065 ignore the platinum store, 24341919 spend the starting platinum on slots); `you-end-up-paying-sooner-or-later` took 23966477 ("bad that you have to buy in game to get the goodies"); `more-to-do-than-fighting` took 23714521 (Conclave and Lunaro).
- **Archwing again** (23577928 will not even try the Archwing boss) on `modes.a-mode-falls-flat`, now 4 files; the open world (23443568, a 2020 edit) went there too.
- **Personal detail left out:** 24487040 tells a long story about the reviewer's health; the one line about the game ("it sure has changed a lot since then") is kept, on `update-cadence.unknown`.
- **Multi-dated reviews flattened this batch:** 23010711 (2016, its disconnection lines from a 2020 edit), 23161305 (2016, 2025 edit), 23160257 (2020 edit), 23317660, 23443674 (2025 edit), 23443568 (2020 edit), 23588277 (2024 edit), 23577928, 23574975, 23716078, 23715572 (2024 edit), 23968727, 23968478 (2025 edit), 24342675, 24341652 (2022 edit), 24487040 (2020 edit).

## Notes - round 424 (Warframe batch 17)

50 read (2016-07-31 to 2016-10-07), 131 bullets, 0 excluded, 18 edited later. Running total 850 of 3,235. 43 up / 7 down - the most thumbs-down in any Warframe batch so far. 19 bullets on an `.unknown`. Tree 1,441 -> 1,448 (7 modes, built on first sighting under Rule C).

- **Built (7):** `game-design.modes.forced-into-a-mode-you-dislike` (-, 24640637: the open world holds items they need, and they hate it). `live-ops.patch-quality.courts-new-players-at-the-veterans-expense` (-, 24640637). `new-player-experience.returning-players-get-no-catch-up` (-, 25276661) and `ui-ux.the-interface-keeps-changing` (-, 25276661). `randomness.the-best-gear-is-not-left-to-chance` (+, 25403248, the twin of `the-thing-you-need-may-never-roll`). `monetisation-practice.the-shop-hides-a-requirement` (-, 25518250: a frame bought with money needs a Mastery Rank the market never mentions - "nearly got conned"). `role-design.some-characters-are-hard-to-master` (-, 25912976, Limbo, listed as a con).
- **The 2016-to-2020 turn shows in the edits:** 24640637 wrote "best free-to-play game ever" in 2016 and a long 2020 edit on the Void being changed, the open world, the MMO direction and veterans leaving; both halves are kept, the 2016 lines marked "said in 2016". 24767819 (2025 edit, 3,631 hours, thumbs down): "a sloppy grindy mess", raids removed and never returned.
...
## Notes - round 426 (Warframe batch 19)

50 read (2016-12-31 to 2017-03-07), 117 bullets, 0 excluded, 13 edited later. Running total 950 of 3,235. 45 up / 5 down. 27 bullets on an `.unknown` (most of them one-line praise). Tree 1,450 -> 1,451 (1 mode, built on first sighting under Rule C).

- **Built (1):** `game-design.game-feel.combat.projectiles-too-slow-to-hit` (-, 29767217: "players move faster than the arrows I shoot out of the bow").
- **A slur and a jab kept out of the text:** 28883335's 2019 edit blames the negative reviews of the time on a review-bomb following a translator the studio let go; it is on `review.says-the-other-reviews-are-not-about-the-game`, and the bullet records "a jab at that former staff member and a slur", repeating neither. 29450135 (a 2026 edit on the Exploiter Orb fight) says the designer should be laid off and ends with an insult at the studio; recorded as "a jab" and "an insult", split into five bullets for the faults it names (no explanations, no ammo, no group queue, impossible solo).
...
## Notes - round 428 (Warframe batch 21 - the first batch of 100)

100 read (2017-05-31 to 2017-10-23), 207 bullets, 0 excluded, 32 edited later. Running total 1,100 of 3,235. 81 up / 19 down. 38 bullets on an `.unknown` (18%). Tree 1,457 -> 1,466 (9 modes, built on first sighting under Rule C). First batch at 100 (Rico, 2026-09-25) and the first written through the new lost-review check: the dry run passed with all 100 of the next 100 ids, and `write_batch.py --gaps` reports no gaps.

- **Quality watch at 100 (Rule 7), computed by script against batches 17-20:** bullets per review fell to 2.07 (2.34-3.52 before), but 57 of the 100 reviews are 15 words or fewer (24-28 of 50 before), so most of the drop is short reviews. On the 16 reviews over 60 words, bullets per review were 5.3 (6.1-7.0 before) and words per bullet 39 (27-38 before) - slightly thinner, at the edge of the earlier range. Not a fail; watched again next batch, and back to 50 if the long-review density stays below 6.
- **Built (9):** `developer-communication.threatened-a-player-with-legal-action` (-, 33569966: the studio went after a dataminer) and `marketing.positioning.drifted-from-its-original-idea` (-, 33569966: little stealth left in "ninjas in space"). `build-and-customisation.wants-to-grow-one-character-instead-of-collecting` (-, 33937339). ui-ux - `.nags-you-to-take-a-break` (-, 35357501), `.text-hard-to-read-on-the-background` (-, 32653861). `co-op-design.puts-you-in-public-games-by-default` (-, 35760206) and `session-flexibility.the-next-mission-starts-without-asking` (-, 35760206: a countdown pulled them into a mission from the upgrade menus). `playing-with-friends.a-way-to-stay-in-touch` (+, 35556829). `monetisation-practice.the-store-would-not-take-their-money` (-, 33752996).
- **Access failures cluster this batch:** a locked account (33938490), the engine stopping (33937985), a graphics-card error (34445594), an update that broke the game (34646904) and a buggy launcher (34090623) - five thumbs-down from the 2017 client.
...
50 read (2021-05-15 to 2021-07-23), 65 bullets, 0 excluded, 7 edited later. Running total 2,000 of 3,235. 46 up / 4 down. Tree unchanged at 1,521: **every bullet fitted an existing mode**, the first batch without one since the 5-minute loop began (round 433). Lost-review check: all 50 on the first dry run; `--gaps` none. Done in the hourly backstop firing; the 5-minute timer (`df8e0d4c`) was still running, so it was not re-created.
...
## Notes - round 462 (Warframe batch 55)

50 read (2024-09-15 to 2024-11-22), 96 bullets, 0 excluded, 7 edited later. Running total 2,800 of 3,235. 46 up / 4 down. Tree 1,535 -> 1,537 (2 modes, built on first sighting under Rule C). Lost-review check: all 50 on the first dry run; `--gaps` none. Done in the 12:45 backstop firing; the timer had died with the session again (re-created as `1ec968eb`).

- **Quality at 50:** from `scripts/batch_quality.py`: bullets per review 1.92, 29 of 50 reviews 15 words or fewer, 8 reviews over 60 words at 5.4 bullets each and 46 words per bullet, 17% of bullets on an `.unknown`. Words per bullet is high because 175579038 (a 2026 edit of about 750 words) is a list of suggestions that reduces to seven complaints.
...
## Notes - round 494 (Escape from Duckov batch 19)

50 read (2025-12-30 to 2026-01-23), 122 bullets, 0 excluded, 0 edited later. Running total 950 of 1,166 (6 excluded so far). 43 up / 7 down. Tree 1,577 -> 1,583. Lost-review check: all 50 on the first dry run; `--gaps` none. Done in the 18:44 backstop firing (timer re-created as `e76e26d2`).

- **Quality at 50:** from `scripts/batch_quality.py`: bullets per review 2.44, 25 of 50 reviews 15 words or fewer, 10 reviews over 60 words at 6.3 bullets each and 26 words per bullet, 14% of bullets on an `.unknown`. 215376918 alone carries 16 bullets (a suggestion list).
- **Six modes built (Rule C):** `community.developer-communication.misused-the-store-announcements` (−, 214702800), `art.animation.actions-have-no-animation` (−, 214699684), `audio.mixing.no-sense-of-direction` (−, 214698247), `review.calls-the-negative-reviews-a-review-bomb` (~, 215438110), `game-design.ui-ux.tooltips-get-in-the-way` (−, 215376918), `engineering.platform-support.runs-poorly-on-my-platform` (−, 216633945).
- **The mod dispute fades into the background:** of the 7 thumbs down, 214702800 and 214698247 name the studio's handling alongside game complaints, 214700421 is a crude jab at the developers, and 214685706 fears a virus (framed with the studio's nationality; not repeated). On the other side, three thumbs-up reviews tell readers to ignore it - 215438110 ("reviewbombing"), 215417183 and 215970764 (40 helpful, "I don't know what the downvotes are about").
- **The late game, again:** 3 more bullets on `the-late-game-turns-into-a-grind` (214702800, 215406767, 215398199); 215398199 says enjoyment "went downhill after the Farm Town region", and 215376918 says Farm Town jumps "from somewhat challenging to absurd".

## Notes - round 495 (Escape from Duckov batch 20)

50 read (2026-01-22 to 2026-02-21), 121 bullets, 0 excluded, 2 edited later. Running total 1,000 of 1,166 (6 excluded so far). 36 up / 14 down. Tree 1,583 -> 1,588. Lost-review check: the first dry run named 217805258 as LOST (left out of the batch); added and re-run, all 50 accounted for; `--gaps` none. Done in the 19:44 backstop firing (timer re-created as `c4290f81`).

- **Quality at 50:** from `scripts/batch_quality.py`: bullets per review 2.42, 29 of 50 reviews 15 words or fewer, 12 reviews over 60 words at 5.8 bullets each and 46 words per bullet, 17% of bullets on an `.unknown`.
- **Five modes built (Rule C):** `marketing.reputation.partnered-with-a-studio-players-dislike` (−, 217253429 and 217251321), `game-design.world-interaction.searching-reveals-loot-slowly` (−, 217252694), `narrative.tone.a-one-note-joke` (−, 217753377), `game-design.game-feel.movement.the-dodge-roll-locks-you-in` (−, 218327208), `game-design.ui-ux.the-interface-is-too-big` (−, 218327208).
