...
- **Precedent kept:** "it is free" praise on `publishing.price.fair` - nine more sightings this batch (6158359, 7190781, 626232, 830179, 3243859, 4673877, 798407, 2069152, 7108076 by way of "free" in 3905761's "big for a free-to-play game" went to `plenty` instead). Running count for the game: 15 in 100.
